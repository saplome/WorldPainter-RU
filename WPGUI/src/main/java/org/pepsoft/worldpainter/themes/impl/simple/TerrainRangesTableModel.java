...
public class TerrainRangesTableModel implements TableModel {
    ...
    public String getColumnName(int columnIndex) {
        switch (columnIndex) {
            case 0:
                return org.pepsoft.worldpainter.WPI18n.s("ui.col.level");
            case 1:
                return org.pepsoft.worldpainter.WPI18n.s("ui.col.terrain_type");
            case 2:
                return org.pepsoft.worldpainter.WPI18n.s("ui.col.actions");
            default:
