...
public class AddTerrainRangeDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.addTerrainMapping.title"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.selectALevelAnd"));

        jLabel2.setLabelFor(spinnerLevel);
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.level"));

        jLabel3.setLabelFor(comboBoxTerrainType);
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.terrain.terrainType"));
