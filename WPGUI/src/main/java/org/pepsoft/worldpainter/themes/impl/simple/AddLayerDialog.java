...
public class AddLayerDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.add_layer_mapping"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.configure.a.layer.to.e03f90c4b6"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.from.1e6d57e813"));

        spinnerFrom.setModel(new javax.swing.SpinnerNumberModel(128, 0, 255, 1));

        jLabel3.setLabelFor(spinnerTo);
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.to.33caa076f2"));

        spinnerTo.setModel(new javax.swing.SpinnerNumberModel(255, 0, 255, 1));

        jLabel4.setLabelFor(comboBoxLayer);
        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.layer.44ecdf0f12"));

        checkBoxFeather.setText(org.pepsoft.worldpainter.WPI18n.s("wp.feather.1e74e9f208"));
