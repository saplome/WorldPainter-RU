...
public final class MapUtils {
    ...
    public static PlatformProvider.MapInfo selectMap(Window parent, File defaultDir) {
        ...
        final File selectedFile = FileUtils.selectDirectoryForOpen(parent, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectExistingMapDir"), mySavesDir, org.pepsoft.worldpainter.WPI18n.s("ui.filter.mapDirectories"), new FileView() {
            @Override
