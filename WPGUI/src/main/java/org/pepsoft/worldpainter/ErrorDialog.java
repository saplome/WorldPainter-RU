...
public class ErrorDialog extends javax.swing.JDialog {
    ...
    public void setException(Throwable exception) {
        ...
        if (exceptionTypes.contains(OutOfMemoryError.class)) {
            setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.out_of_memory"));
            final Integer threadCount = getMostRecentThreadCount();
            if ((threadCount != null) && (threadCount > 1)) {
                jTextArea1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.h.d0c31b0fc2") +
                    org.pepsoft.worldpainter.WPI18n.s("ui.h.2d1d30f57d") +
                    org.pepsoft.worldpainter.WPI18n.s("ui.h.23048e2601") + (threadCount - 1) + org.pepsoft.worldpainter.WPI18n.s("ui.h.804eaaca7c") +
                    org.pepsoft.worldpainter.WPI18n.s("ui.h.9c7fdad033"));
            } else {
                jTextArea1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.h.d0c31b0fc2")
                    + org.pepsoft.worldpainter.WPI18n.s("ui.h.5152003742")
                    + org.pepsoft.worldpainter.WPI18n.s("ui.h.2ae3e5340f")
                    + org.pepsoft.worldpainter.WPI18n.s("ui.h.f1cccffb9b")
                    + org.pepsoft.worldpainter.WPI18n.s("ui.h.0a2934860b"));
            }
            jButton1.setEnabled(false);
            jButton1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.not.necessary.to.send.130c2e230e"));
            ...
            if ((Main.privateContext != null) && (! forceEmail)) {
                ...
                jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.email.details.10006b5c26"));
                if ((! Desktop.isDesktopSupported()) || (! Desktop.getDesktop().isSupported(Desktop.Action.MAIL))) {
                    jButton1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.emailing.not.supported.on.4e96dba522"));
                } else {
    ...
    private void email() {
        try {
            ...
            JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.d624dc75e9"), org.pepsoft.worldpainter.WPI18n.s("ui.h.b9b98846b4"), JOptionPane.ERROR_MESSAGE);
        } catch (IOException e) {
    ...
    private void submitInBackground() {
        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.sending.7b0fee4d95"));
        jButton1.setEnabled(false);
        ...
        new Thread("Exception Submitter") {
            ...
            public void run() {
                try {
                    ...
                    doOnEventThread(() -> {
                        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.report.sent.118e3fea0a"));
                        jButton2.setEnabled(true);
                    });
                } catch (RuntimeException e) {
                    logger.error("{} while trying to submit exception report to server (message: {})", e.getClass().getSimpleName(), e.getMessage(), e);
                    doOnEventThread(() -> {
                        JOptionPane.showMessageDialog(ErrorDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.1e3c25c3d2"), org.pepsoft.worldpainter.WPI18n.s("information"), JOptionPane.INFORMATION_MESSAGE);
                        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.email.details.10006b5c26"));
                        if ((! Desktop.isDesktopSupported()) || (! Desktop.getDesktop().isSupported(Desktop.Action.MAIL))) {
                            jButton1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.emailing.not.supported.on.4e96dba522"));
                        } else {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.unexpected_error"));

        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.send.report.976b536745"));
        ...
        jButton2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.close.d3d2e61733"));
        ...
        jButton3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.copy.details.to.clipboard.cd5f81bdf0"));
