...
public class RotateWorldDialog extends WorldPainterDialog {
    ...
    public RotateWorldDialog(Window parent, World2 world, Anchor anchor) {
        ...
        initComponents();
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.p.rotate") + new Anchor(anchor.dim, DETAIL, false, 0).getDefaultName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.d02e9b154a"));
    ...
    private void rotate() {
        ...
        ProgressDialog.executeTask(this, new ProgressTask<Void>() {
            ...
            public String getName() {
                return org.pepsoft.worldpainter.WPI18n.s("rotating.dimensions");
            }
        ...
        if (affectedDimensions.stream().flatMap(dimension -> dimension.getOverlays().stream()).anyMatch(overlay -> ! overlay.getFile().canRead())) {
            beepAndShowWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.rotate.overlaysNotAdjusted.message"), org.pepsoft.worldpainter.WPI18n.s("ui.rotate.overlaysNotAdjusted.title"));
        } else if (affectedDimensions.stream().anyMatch(dimension -> ! dimension.getOverlays().isEmpty())) {
            beepAndShowWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.rotate.overlaysNotRotated.message"), org.pepsoft.worldpainter.WPI18n.s("ui.rotate.overlaysNotRotated.title"));
        }
        ok();
    }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.rotate_world"));
        setResizable(false);

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.choose.a.rotation.angle.2f195fd9af"));
        ...
        buttonRotate.setText(org.pepsoft.worldpainter.WPI18n.s("wp.rotate.8d2de53685"));
        ...
        jRadioButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.degrees.clockwise.c8a13038a9"));

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.degrees.ccef428aff"));

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.degrees.anticlockwise.496fd18488"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.em.this.operation.555e477e82"));

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.i.all.associated.2372f835de"));
