...
public class CustomMaterialDialog extends WorldPainterDialog implements PropertyChangeListener  {
        ...
        tableMaterialRows.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ((row != -1) && (column == COLUMN_MATERIAL)) {
                    ...
                    dialog.setTitle(org.pepsoft.worldpainter.WPI18n.s("wp.edit.material.4bf41ae5b1"));
                    ...
                    JButton cancelButton = new JButton(org.pepsoft.worldpainter.WPI18n.s("ui.ea4788705e"));
    ...
    private void saveSettings() {
        switch (jTabbedPane1.getSelectedIndex()) {
            case 0:
                ...
                final String name = java.util.Objects.equals(fieldName.getText(), previousCalculatedName)
    ...
    private String createName(Material material) {
        return platform.capabilities.contains(NAME_BASED) ? material.toString() : material.toLegacyString();
    }
    ...
    private void pickColour() {
        Color pick = JColorChooser.showDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectColour"), new Color(selectedColour));
        if (pick != null) {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.select_custom_material"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.name.4e140ba723"));

        fieldName.setColumns(20);

        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.colour.3418ffe125"));

        labelColour.setText("                 ");
        labelColour.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.select.to.override.actual.4ac4a11441"));
        ...
        checkBoxColour.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.select.to.override.actual.4ac4a11441"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(labelPreview, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
        );
        ...
        buttonLoad.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.load.this.custom.material.c63113e88a"));
        ...
        buttonSave.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.save.this.custom.material.d923885e14"));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(materialEditor1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        buttonAddMaterial.setText(org.pepsoft.worldpainter.WPI18n.s("wp.add.material.fe79e174ee"));
        ...
        buttonRemoveMaterial.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.material.ae32643ea0"));
        ...
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.variation.5688482b44"));
        ...
        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.z.axis.angle.a17e32b419"));
        ...
        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.x.axis.angle.4a393c2f75"));
        ...
        radioButtonLayered.setText(org.pepsoft.worldpainter.WPI18n.s("wp.layers.87bfda183c"));
        ...
        radioButtonNoise.setSelected(true);
        radioButtonNoise.setText(org.pepsoft.worldpainter.WPI18n.s("wp.noise.9b27ee4c75"));
        ...
        radioButtonBlobs.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blobs.d6666d6624"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.block.id.e7a58f9794"));

        checkBoxLayeredRepeat.setSelected(true);
        checkBoxLayeredRepeat.setText(org.pepsoft.worldpainter.WPI18n.s("wp.repeat.dbdc557253"));
    ...
    private void updateName() {
        if (java.util.Objects.equals(fieldName.getText(), previousCalculatedName)) {
