        ...
        if (world == this.world) {
            ...
            if ((masterDimension != null) && (surfaceDimension.getTileCount() == 0)) {
                ...
                doLaterOnEventThread(() -> JOptionPane.showMessageDialog(App.this,
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.71f20333bc") +
                                org.pepsoft.worldpainter.WPI18n.s("ui.h.159a1bd767") +
                                "\n" +
                                org.pepsoft.worldpainter.WPI18n.s("ui.h.133b0b19ee") +
                                "pressing " + COMMAND_KEY_NAME + org.pepsoft.worldpainter.WPI18n.s("ui.h.edb30f7c66") +
                                "pressing " + COMMAND_KEY_NAME + org.pepsoft.worldpainter.WPI18n.s("ui.h.84cf952144"), org.pepsoft.worldpainter.WPI18n.s("ui.h.1c030d4421"), INFORMATION_MESSAGE));
            } else {
    ...
    public void setDimension(final Dimension dimension) {
        ...
        if (dimension != null) {
            ...
            if (warnings.length() > 0) {
                ...
                showMessageDialog(this, warnings.toString(), org.pepsoft.worldpainter.WPI18n.s("ui.h.6f8873ae12"), ERROR_MESSAGE);
            }
...
//            selectionState.setValue(false);
            ...
            for (Warning warning: warnings) {
                switch (warning) {
                    case AUTO_BIOMES_DISABLED:
                        if (showOptionDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.4b1fea7072"), org.pepsoft.worldpainter.WPI18n.s("ui.h.0a43f5ce64"), DEFAULT_OPTION, WARNING_MESSAGE, null, new Object[] {org.pepsoft.worldpainter.WPI18n.s("ui.h.e3487fd1b5"), "OK"}, "OK") == 0) {
                            try {
                    ...
                    case AUTO_BIOMES_ENABLED:
                        if (showOptionDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.84c7f3ab67"), org.pepsoft.worldpainter.WPI18n.s("ui.h.8f3757cffd"), DEFAULT_OPTION, WARNING_MESSAGE, null, new Object[] {org.pepsoft.worldpainter.WPI18n.s("ui.h.e3487fd1b5"), "OK"}, "OK") == 0) {
                            try {
                                DesktopUtils.open(new URL("https://www.worldpainter.net/doc/legacy/newautomaticbiomes"));
                            } catch (MalformedURLException e) {
                                throw new RuntimeException(e);
    ...
    void shiftWorld(Window parent) {
        if ((world == null) || (dimension == null)) {
            DesktopUtils.beep();
            return;
        } else if ((world.getImportedFrom() != null) && (showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.h.d3e44c8d6f"), strings.getString("imported"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION)) {
            return;
        }
    ...
    void scaleWorld(Window parent) {
        if ((world == null) || (dimension == null)) {
            DesktopUtils.beep();
            return;
        } else if ((world.getImportedFrom() != null) && (showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.h.05bfaf4d07"), strings.getString("imported"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION)) {
            return;
        }
        view.setInhibitUpdates(true);
        try {
            ...
            if (recentFile.isFile() && recentFile.canRead()) {
                ...
                menuItem.addActionListener(e -> {
                    if (recentFile.isFile()) {
                        ...
                        JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.0b8c2d31e3") + recentFile.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.3d8666efe7") + recentFile.getParent(), org.pepsoft.worldpainter.WPI18n.s("ui.h.c7d4bfc924"), JOptionPane.ERROR_MESSAGE);
                    }
                });
...
//        popupMenu.add(label);
    ...
    private void open() {
        ...
        if (selectedFile != null) {
            if (! selectedFile.isFile()) {
                ...
                showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.57cf606154"), org.pepsoft.worldpainter.WPI18n.s("ui.h.8ede7e376a"), ERROR_MESSAGE);
                return;
            }
            if (! selectedFile.canRead()) {
                showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.857192af4c"), org.pepsoft.worldpainter.WPI18n.s("ui.h.095afbf2f1"), ERROR_MESSAGE);
                return;
            }
            open(selectedFile);
            if (config != null) {
    ...
    private JPanel createStatusBar() {
        ...
        biomeLabel = new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.h.43ba95a402"));
    ...
    private JPanel createToolPanel() {
        ...
        eyedropperToggleButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.eyedropper.select.a.paint.dce0254821"));
...
//            selectionState.setValue(false);
        ...
        clearSelectionButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.clear.the.selection.d81dfeb6fc"));
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                switch ((TerrainMode) value) {
                    ...
                    case HIDE_TERRAIN:
                        ...
                        setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.hide_terrain"));
                        break;
    ...
    private JPanel createBiomesPanelContainer() {
        ...
        checkBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.uncheck.to.hide.biomes.b491b13c1a"));
        ...
        soloCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.check.to.show.5519f14675"));
    ...
    private JPanel createAnnotationsPanel() {
        ...
        checkBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.uncheck.to.hide.annotations.b870299068"));
        checkBox.addActionListener(e -> {
            if (checkBox.isSelected()) {
        ...
        JCheckBox soloCheckBox = new JCheckBox(org.pepsoft.worldpainter.WPI18n.s("ui.e23a62ef2c"));
        soloCheckBox.setHorizontalTextPosition(SwingConstants.LEADING);
        soloCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.check.to.show.c3d5ca8ccc"));
    ...
    private JPanel createTerrainPanel() {
        ...
        if (! config.isEasyMode()) {
            ...
            checkBoxSoloTerrain.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.check.to.show.5519f14675"));
...
//            }
    ...
    private JMenu createFileMenu() {
        ...
        if (! config.isEasyMode()) {
            ...
            menuItem.setText(org.pepsoft.worldpainter.WPI18n.s("wp.from.minecraft.map.267acef65b"));
    ...
    private JMenu createEditMenu() {
        ...
        extendedBlockIdsMenuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.allow.block.ids.from.c91196140f"));
        ...
        menuItem.setText(org.pepsoft.worldpainter.WPI18n.s("wp.custom.layer.s.from.59a1d3128b"));
        importMenu.add(menuItem);
...
//                Configuration config = Configuration.getInstance();
//                if (config.isEasyMode()) {
//                    if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.9058361c79"), org.pepsoft.worldpainter.WPI18n.s("ui.h.18cb7ce744"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
//                        config.setEasyMode(false);
//                        try {
//                            config.save();
//                            easyModeItem.setSelected(true);
//                            JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.6ab073bab5"), org.pepsoft.worldpainter.WPI18n.s("ui.h.f2087ac131"), JOptionPane.INFORMATION_MESSAGE);
...
//                    }
//                } else {
//                    if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.45153ef3fd"), org.pepsoft.worldpainter.WPI18n.s("ui.h.18cb7ce744"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
//                        config.setEasyMode(true);
//                        try {
//                            config.save();
//                            easyModeItem.setSelected(false);
//                            JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.3ff0f32377"), org.pepsoft.worldpainter.WPI18n.s("ui.h.f2087ac131"), JOptionPane.INFORMATION_MESSAGE);
//                        } catch (IOException exception) {
//                            ErrorDialog errorDialog = new ErrorDialog(App.this);
//                            errorDialog.setException(exception);
//                            errorDialog.setVisible(true);
...
//        menu.add(easyModeItem);
    ...
    private JMenu createToolsMenu() {
        ...
        if (Configuration.getInstance().isSafeMode()) {
            menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.biomes.viewer.not.available.d16db3a4cb"));
        } else {
            menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.biomes.subsystem.initialising.f531101c35"));
            ...
            new Thread("Biomes Viewer Menu Item Initialiser") {
                ...
                public void run() {
                    if (BiomeSchemeManager.getAvailableBiomeAlgorithms().isEmpty()) {
                        ...
                        doLaterOnEventThread(() -> biomesViewerMenuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.no.supported.minecraft.installation.8ba8e92f3c")));
                    } else {
...
//        menu.add(ACTION_SHOW_HELP_PICKER);
        ...
        // --- Language selection (community EN/RU localization pack) ---
        menu.addSeparator();
        ...
        javax.swing.JRadioButtonMenuItem englishItem = new javax.swing.JRadioButtonMenuItem("English");
        englishItem.setSelected(! "ru".equalsIgnoreCase(currentLang));
        englishItem.addActionListener(e -> {
            org.pepsoft.worldpainter.WPI18n.setLanguage("en");
            javax.swing.JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.1f31db910f"), org.pepsoft.worldpainter.WPI18n.s("ui.h.4994a8ffeb"), javax.swing.JOptionPane.INFORMATION_MESSAGE);
        });
        languageGroup.add(englishItem);
        languageMenu.add(englishItem);
        javax.swing.JRadioButtonMenuItem russianItem = new javax.swing.JRadioButtonMenuItem("\u0420\u0443\u0441\u0441\u043a\u0438\u0439 (Russian)");
        russianItem.setSelected("ru".equalsIgnoreCase(currentLang));
        russianItem.addActionListener(e -> {
            org.pepsoft.worldpainter.WPI18n.setLanguage("ru");
            javax.swing.JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.1f31db910f"), org.pepsoft.worldpainter.WPI18n.s("ui.h.4994a8ffeb"), javax.swing.JOptionPane.INFORMATION_MESSAGE);
        });
        languageGroup.add(russianItem);
    ...
    private void removeCeiling() {
        ...
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.cb2b60140b") + ceiling.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.10d553ac7c"), org.pepsoft.worldpainter.WPI18n.s("ui.h.672add4f73") + ceiling.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.4f46d23026"), YES_NO_OPTION) == YES_OPTION) {
...
//        toolBar.add(ACTION_SHOW_HELP_PICKER);
    ...
    private void removeNether() {
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.64b7e14278"), org.pepsoft.worldpainter.WPI18n.s("ui.h.8796c3b990"), YES_NO_OPTION) == YES_OPTION) {
    ...
    private void removeEnd() {
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.e368d0ede9"), org.pepsoft.worldpainter.WPI18n.s("ui.h.2ca6b8a850"), YES_NO_OPTION) == YES_OPTION) {
    ...
    private void removeMaster() {
        ...
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.cb2b60140b") + master.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.10d553ac7c"), org.pepsoft.worldpainter.WPI18n.s("ui.h.672add4f73") + master.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.4f46d23026"), YES_NO_OPTION) == YES_OPTION) {
...
//            }
    ...
    private List<Component> createLayerRow(final Layer layer, final boolean createShowCheckbox, final boolean createSoloCheckbox, final JComponent layerComponent) {
        ...
        if (createSoloCheckbox) {
            ...
            soloCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.check.to.show.1b6bf56ec8"));
    ...
    private boolean importCustomMaterials() {
        if (dimension == null) {
            ...
            showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.161eba0d49"), org.pepsoft.worldpainter.WPI18n.s("ui.h.88f577f4ad"), ERROR_MESSAGE);
            return false;
        }
    ...
    private void removeCustomMaterial(int index) {
        ...
        if (allTerrains.contains(customTerrain)) {
            ...
            JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.c0369138bf") + name + org.pepsoft.worldpainter.WPI18n.s("ui.h.4145f23ecb"), org.pepsoft.worldpainter.WPI18n.s("ui.h.630ecf4a19"), ERROR_MESSAGE);
            return;
        }
        ...
        for (CustomLayer layer: allLayers) {
            if ((layer instanceof CombinedLayer) && (((CombinedLayer) layer).getTerrain() == customTerrain)) {
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.c0369138bf") + name + org.pepsoft.worldpainter.WPI18n.s("ui.h.25bf59d644") + layer.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.6fe00d0780"), org.pepsoft.worldpainter.WPI18n.s("ui.h.630ecf4a19"), ERROR_MESSAGE);
                return;
            }
        }

        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.95a3b4d51a") + name + org.pepsoft.worldpainter.WPI18n.s("ui.h.597bda5293"), org.pepsoft.worldpainter.WPI18n.s("ui.h.44928cfda5"), YES_NO_OPTION) == YES_OPTION) {
        ...
        if (selectedFile != null) {
            ...
            if (CustomItemsTreeModel.hasCustomItems(selectedWorld, itemType)) {
                ...
                if (! dialog.isCancelled()) {
                    ...
                    if (errors.length() > 0) {
                        JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.8e030a5580") + errors, org.pepsoft.worldpainter.WPI18n.s("ui.h.761e44bdcd"), showError ? JOptionPane.ERROR_MESSAGE : JOptionPane.WARNING_MESSAGE);
                    }
                }
            } else {
                final String what;
...
//            view.moveTo(location);
    ...
    private final BetterAction ACTION_RESET_DOCKS = new BetterAction("resetDockLayout", "Reset current and default") {
        ...
        protected void performAction(ActionEvent e) {
            DesktopUtils.beep();
            if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.fdb9edeb7a"), org.pepsoft.worldpainter.WPI18n.s("ui.h.504d673488"), YES_NO_OPTION) == YES_OPTION) {
                dockingManager.resetToDefault();
                Configuration config = Configuration.getInstance();
    ...
    private final BetterAction ACTION_RESET_ALL_DOCKS = new BetterAction("resetAllDockLayout", "Reset current, default and all saved worlds") {
        ...
        protected void performAction(ActionEvent e) {
            DesktopUtils.beep();
            if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.ddfa37585d"), org.pepsoft.worldpainter.WPI18n.s("ui.h.504d673488"), YES_NO_OPTION) == YES_OPTION) {
                dockingManager.resetToDefault();
                Configuration config = Configuration.getInstance();
                config.setDefaultJideLayoutData(null);
