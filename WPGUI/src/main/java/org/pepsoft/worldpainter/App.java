...
public final class App extends JFrame implements BrushControl,
        ...
        if (world == this.world) {
            ...
            if ((masterDimension != null) && (surfaceDimension.getTileCount() == 0)) {
                ...
                doLaterOnEventThread(() -> JOptionPane.showMessageDialog(App.this,
                        org.pepsoft.worldpainter.WPI18n.s("ui.dialog.editingMasterDimension.exportedNote") +
    ...
    public void setDimension(final Dimension dimension) {
        ...
        if (dimension != null) {
            setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.p.worldpainter") + world.getName() + " - " + org.pepsoft.worldpainter.WPI18n.dimensionName(dimension)); // NOI18N
            ...
            if (warnings.length() > 0) {
                ...
                showMessageDialog(this, warnings.toString(), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.customTerrainNotRestored.title"), ERROR_MESSAGE);
            }
...
//            selectionState.setValue(false);
    ...
    public void updateStatusBar(int x, int y) {
        ...
        if (tile == null) {
            ...
            if (dimension.isBorderTile(x >> TILE_SIZE_BITS, y >> TILE_SIZE_BITS)) {
                setTextIfDifferent(materialLabel, strings.getString("border"));
            } else {
        ...
        setTextIfDifferent(slopeLabel, MessageFormat.format(strings.getString("slope.0.degrees"), (int) round(Math.atan(dimension.getSlope(x, y)) * 180 / Math.PI)));
        ...
        if (terrain.isCustom()) {
            ...
            setTextIfDifferent(materialLabel, MessageFormat.format(strings.getString("material.0"), org.pepsoft.worldpainter.WPI18n.terrainName(terrain)));
        }
        ...
        if (biomeHelper != null) {
            ...
            if (biome == 255) {
                ...
                if (biome != -1) {
                    setTextIfDifferent(biomeLabel, MessageFormat.format(strings.getString("auto.biome.0"), biomeHelper.getBiomeName(biome)));
                }
            } else if (biome != -1) {
    ...
    public void open(File file, boolean askForConfirmation) {
        if (askForConfirmation && (world != null) && (world.getChangeNo() != lastSavedState)) {
            int action = showConfirmDialog(this, strings.getString("there.are.unsaved.changes"), strings.getString("save.world"), YES_NO_CANCEL_OPTION);
            ...
            for (Warning warning: warnings) {
                switch (warning) {
                    case AUTO_BIOMES_DISABLED:
                        if (showOptionDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.automaticBiomesDisabledNotice"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.automaticBiomesDisabled.title"), DEFAULT_OPTION, WARNING_MESSAGE, null, new Object[] {org.pepsoft.worldpainter.WPI18n.s("ui.dialog.moreInfo.title"), "OK"}, "OK") == 0) {
                            try {
                    ...
                    case AUTO_BIOMES_ENABLED:
                        if (showOptionDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.automaticBiomesEnabledNotice"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.automaticBiomesEnabled.title"), DEFAULT_OPTION, WARNING_MESSAGE, null, new Object[] {org.pepsoft.worldpainter.WPI18n.s("ui.dialog.moreInfo.title"), "OK"}, "OK") == 0) {
                            try {
                                DesktopUtils.open(new URL("https://www.worldpainter.net/doc/legacy/newautomaticbiomes"));
                            } catch (MalformedURLException e) {
                                throw new RuntimeException(e);
                    ...
                    case MISSING_CUSTOM_TERRAINS:
                        showWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.warning.missingCustomTerrains.message"), org.pepsoft.worldpainter.WPI18n.s("ui.warning.missingCustomTerrains.title"));
                        break;
                    case SUPERFLAT_SETTINGS_RESET:
                        showWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.warning.superflatPresetReset.message"), org.pepsoft.worldpainter.WPI18n.s("ui.warning.superflatPresetReset.title"));
                        break;
                    case GAME_TYPE_RESET:
                        showWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.warning.gameModeReset.message"), org.pepsoft.worldpainter.WPI18n.s("ui.warning.gameModeReset.title"));
                        break;
                }
            }
        }
            ...
            if (showConfirmDialog(this, strings.getString("this.world.is.128.blocks.high"), strings.getString("convert.world.height"), YES_NO_OPTION) == YES_OPTION) {
                ProgressDialog.executeTask(this, new ProgressTask<Void>() {
                    ...
                    public String getName() {
                        return strings.getString("changing.world.height");
                    }
    ...
    void shiftWorld(Window parent) {
        if ((world == null) || (dimension == null)) {
            DesktopUtils.beep();
            return;
        } else if ((world.getImportedFrom() != null) && (showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.shiftDimension.importedWarning"), strings.getString("imported"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION)) {
            return;
        }
    ...
    void scaleWorld(Window parent) {
        if ((world == null) || (dimension == null)) {
            DesktopUtils.beep();
            return;
        } else if ((world.getImportedFrom() != null) && (showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.scaleDimension.importedWarning"), strings.getString("imported"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION)) {
            return;
        }
        view.setInhibitUpdates(true);
        try {
            ...
            if (recentFile.isFile() && recentFile.canRead()) {
                ...
                menuItem.addActionListener(e -> {
                    if (recentFile.isFile()) {
                        ...
                        JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.filePrefix") + recentFile.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.message.fileNoLongerExistsSuffix") + recentFile.getParent(), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.fileRemoved.title"), JOptionPane.ERROR_MESSAGE);
                    }
                });
    ...
    public boolean saveIfNecessary() {
        ...
        try {
            if ((world != null) && (world.getChangeNo() != lastSavedState)) {
                int action = showConfirmDialog(this, (lastSelectedFile != null) ? (MessageFormat.format(strings.getString("there.are.unsaved.changes.do.you.want.to.save.the.world.to.0"), lastSelectedFile.getName())) : strings.getString("there.are.unsaved.changes"), strings.getString("save.world"), YES_NO_CANCEL_OPTION);
                if (action == YES_OPTION) {
                    if (! save()) {
            ...
            try {
                ...
                beepAndShowWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.app.clearAutosaveFailed.message"), org.pepsoft.worldpainter.WPI18n.s("ui.app.clearAutosaveFailed.title"));
            }
            return true;
        } finally {
            resumeAutosave();
...
//        popupMenu.add(label);
    ...
    public void customBiomeRemoved(CustomBiome customBiome) {
        if ((! programmaticChange) && (dimension != null)) {
            ProgressDialog.executeTask(this, new ProgressTask<Void>() {
                @Override
                public String getName() {
                    return MessageFormat.format(strings.getString("removing.custom.biome.0"), customBiome.getName());
                }
    ...
    // Capture restart dialog texts in the current locale, persist the new language, then prompt.
    private void promptAndSwitchLanguage(String lang) {
        // 1) Read the dialog texts while the OLD locale is still active.
        final String message = org.pepsoft.worldpainter.WPI18n.s("ui.h.langRestartNow");
        final String title = org.pepsoft.worldpainter.WPI18n.s("ui.dialog.restartRequired.title");
        final String yesText = org.pepsoft.worldpainter.WPI18n.s("ui.h.langRestartYes");
        final String noText = org.pepsoft.worldpainter.WPI18n.s("ui.h.langRestartNo");
        // 2) Persist the chosen language and update the JVM default locale.
        org.pepsoft.worldpainter.WPI18n.setLanguage(lang);
        // 3) Show the confirmation using the pre-switch texts and custom buttons.
    ...
    private void restartApplication(String failedMessageKey) {
        ...
        try {
            // Build the command that launches a fresh WorldPainter, and launch the
            // target executable DIRECTLY (no cmd.exe, no .bat helper). The old script
            // approach flashed a console window and -- in non-jpackage launches --
            // rebuilt a broken classpath, so the child died before showing a window.
            // On Windows we use javaw.exe / the native launcher: both are GUI-subsystem
            // binaries, so no console window appears.
            final java.util.List<String> relaunch = new java.util.ArrayList<>();
            final String appPath = System.getProperty("jpackage.app-path");
            if ((appPath != null) && ! appPath.trim().isEmpty()) {
                // Installed app: relaunch the native jpackage launcher directly.
                relaunch.add(appPath);
            } else {
                // Plain-Java launch (Maven / IDE / java -cp / java -jar). Use javaw on
                // Windows so no console window appears. When launched this way
                // java.class.path contains the full classpath, so reconstructing the
                // command is reliable.
                relaunch.add(System.getProperty("java.home") + java.io.File.separator + "bin" + java.io.File.separator + (windows ? "javaw" : "java"));
                // Preserve the original JVM options, but drop debugger/agent options
                // that cannot bind a second time (they would kill the child).
                for (String jvmArg : java.lang.management.ManagementFactory.getRuntimeMXBean().getInputArguments()) {
                    final String lower = jvmArg.toLowerCase(java.util.Locale.ROOT);
                    if (lower.startsWith("-agentlib:jdwp") || lower.startsWith("-agentpath") || lower.startsWith("-javaagent")
                            || lower.startsWith("-xrunjdwp") || lower.equals("-xdebug")
                            || lower.startsWith("-dworldpainter.restartdelaymillis")) {
                        continue;
                    }
                    relaunch.add(jvmArg);
                }
                // Ask the fresh instance to wait briefly so THIS process can finish
                // shutting down (save its configuration and release the lock file).
                relaunch.add("-Dworldpainter.restartDelayMillis=1200");
                // Point the new JVM at WorldPainter: reuse the original -jar form when
                // possible (preserves the manifest Class-Path), otherwise use the
                // classpath plus the known main class.
                final String javaCommand = System.getProperty("sun.java.command", "").trim();
                final String firstToken = javaCommand.isEmpty() ? "" : javaCommand.split("\\s+")[0];
                if (firstToken.toLowerCase(java.util.Locale.ROOT).endsWith(".jar") && new java.io.File(firstToken).isFile()) {
                    relaunch.add("-jar");
                    relaunch.add(firstToken);
                } else {
                    ...
                    relaunch.add("org.pepsoft.worldpainter.Main");
                }
            }

            // Launch the fresh instance directly and detached; discard its I/O so it is
            // fully decoupled from this (about to exit) process.
            final ProcessBuilder pb = new ProcessBuilder(relaunch);
    ...
    private void open() {
        ...
        File selectedFile = FileUtils.selectFileForOpen(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectWorldPainterWorld"), dir,
                new FileFilter() {
                    @Override
        ...
        if (selectedFile != null) {
            if (! selectedFile.isFile()) {
                ...
                showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.pathNotFile"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.fileNotExist.title"), ERROR_MESSAGE);
                return;
            }
            if (! selectedFile.canRead()) {
                showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.fileNotAuthorised"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.accessDenied.title"), ERROR_MESSAGE);
                return;
            }
            open(selectedFile);
            if (config != null) {
    ...
    private boolean saveAs() {
        ...
        try {
            ...
            file = FileUtils.selectFileForSave(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.saveWorldPainterWorld"), file, new FileFilter() {
                @Override
                public boolean accept(File f) {
                    return f.isDirectory()
                            || f.getName().toLowerCase().endsWith(".world");
    ...
    private boolean save(File file) {
        ...
        try {
            ...
            if (worldName.length() != name.length()) {
                world.setName(name);
                setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.p.worldpainter") + name + " - " + org.pepsoft.worldpainter.WPI18n.dimensionName(dimension)); // NOI18N
            } else {
                for (int i = 0; i < name.length(); i++) {
                    if ((name.charAt(i) != '_') && (name.charAt(i) != worldName.charAt(i))) {
                        world.setName(name);
    ...
    private void autosave() {
        try {
            ...
            ProgressDialog.executeTask(this, new ProgressTask<java.lang.Void>() {
                @Override
                public String getName() {
                    return strings.getString("autosaving");
                }
            ...
            beepAndShowWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.app.autosaveFailed.message"), org.pepsoft.worldpainter.WPI18n.s("ui.app.autosaveFailed.title"));
        }
    }
    ...
    private JPanel createStatusBar() {
        ...
        biomeLabel = new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.label.autoBiomeMegaSpruceTaigaHills"));
    ...
    private JPanel createToolPanel() {
        ...
        eyedropperToggleButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.field.eyedropperSelectAPaint"));
...
//            selectionState.setValue(false);
        ...
        clearSelectionButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.button.clearTheSelection"));
    ...
    private JPanel createLayerPanel() {
        ...
        JideLabel label = new JideLabel(org.pepsoft.worldpainter.WPI18n.s("ui.label.show"));
        label.setOrientation(SwingConstants.VERTICAL);
        label.setClockwise(false);
        label.setMinimumSize(label.getPreferredSize());
        constraints.anchor = GridBagConstraints.SOUTH;
        layerPanel.add(label, constraints);
        label = new JideLabel(org.pepsoft.worldpainter.WPI18n.s("ui.label.solo"));
        label.setOrientation(SwingConstants.VERTICAL);
        label.setClockwise(false);
        label.setMinimumSize(label.getPreferredSize());
        layerPanel.add(label, constraints);
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                switch ((TerrainMode) value) {
                    ...
                    case HIDE_TERRAIN:
                        ...
                        setText(org.pepsoft.worldpainter.WPI18n.s("ui.action.hideTerrain"));
                        break;
    ...
    private JPanel createBrushPanel() {
        ...
        brushPanel.add(createBrushButton(new BitmapBrush(App.class.getResourceAsStream("resources/brush_cracked_earth.png"), strings.getString("ui.menu.cracks"))));
...
//            }
    ...
    private JMenu createFileMenu() {
        ...
        JMenu menu = new JMenu(strings.getString("ui.menu.file"));
        menu.setMnemonic('i');
        menu.add(menuItem);
        ...
        if (! config.isEasyMode()) {
            ...
            menuItem.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.fromMinecraftMap"));
            JMenu subMenu = new JMenu(strings.getString("ui.menu.importWorld"));
        ...
        if (config.isEasyMode()) {
            ...
            JMenu exportMenu = new JMenu(strings.getString("ui.export.verb"));
    ...
    private JMenu createEditMenu() {
        ...
        JMenu menu = new JMenu(strings.getString("ui.menu.edit"));
        menu.setMnemonic('e');
        menu.add(menuItem);
...
//        importMenu.add(menuItem);
        ...
        menuItem = new JMenuItem(strings.getString("ui.dialog.globalOperations.title") + "...");
...
//                Configuration config = Configuration.getInstance();
//                if (config.isEasyMode()) {
//                    if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.switchOnAdvancedMode"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.pleaseConfirm.title"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
//                        config.setEasyMode(false);
//                        try {
//                            config.save();
//                            easyModeItem.setSelected(true);
//                            JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.advancedModeActivated"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.restartRequired.title"), JOptionPane.INFORMATION_MESSAGE);
...
//                    }
//                } else {
//                    if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.switchOffAdvancedMode"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.pleaseConfirm.title"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
//                        config.setEasyMode(true);
//                        try {
//                            config.save();
//                            easyModeItem.setSelected(false);
//                            JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.advancedModeDeactivated"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.restartRequired.title"), JOptionPane.INFORMATION_MESSAGE);
//                        } catch (IOException exception) {
//                            ErrorDialog errorDialog = new ErrorDialog(App.this);
//                            errorDialog.setException(exception);
//                            errorDialog.setVisible(true);
...
//        menu.add(easyModeItem);
        ...
        if ((! config.isEasyMode()) && (! hidePreferences)) {
            ...
            menuItem = new JMenuItem(strings.getString("ui.dialog.preferences.title") + "...");
    ...
    private JMenu createViewMenu() {
        ...
        menuItem.setMnemonic('i');
        JMenu menu = new JMenu(strings.getString("ui.menu.view"));
        menu.setMnemonic('v');
        menu.add(menuItem);
    ...
    private JMenu createToolsMenu() {
        ...
        if (Configuration.getInstance().isSafeMode()) {
            menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.field.biomesViewerNotAvailable"));
        } else {
            menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.field.biomesSubsystemInitialising"));
            ...
            new Thread("Biomes Viewer Menu Item Initialiser") {
                ...
                public void run() {
                    if (BiomeSchemeManager.getAvailableBiomeAlgorithms().isEmpty()) {
                        ...
                        doLaterOnEventThread(() -> biomesViewerMenuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.label.noSupportedMinecraftInstallation")));
                    } else {
        ...
        menuItem.addActionListener(e -> {
            try {
                ...
                beepAndShowError(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.app.newerJavaRequired.message"), org.pepsoft.worldpainter.WPI18n.s("ui.app.newerJavaRequired.title"));
            }
        });
        menuItem.setMnemonic('s');
        menu.add(menuItem);
    ...
    private JMenu createHelpMenu() {
        ...
        JMenu menu = new JMenu(strings.getString("ui.menu.help"));
//        menu.setMnemonic('h');
        menu.add(menuItem);
...
//        menu.add(ACTION_SHOW_HELP_PICKER);
        ...
        // Language selection
        menu.addSeparator();
        javax.swing.JMenu languageMenu = new javax.swing.JMenu("Language / \u042f\u0437\u044b\u043a");
        javax.swing.ButtonGroup languageGroup = new javax.swing.ButtonGroup();
        String currentLang = org.pepsoft.worldpainter.WPI18n.getLanguage();
        for (java.util.Map.Entry<String, String> languageEntry : org.pepsoft.worldpainter.WPI18n.getAvailableLanguages().entrySet()) {
            final String languageCode = languageEntry.getKey();
            javax.swing.JRadioButtonMenuItem languageItem = new javax.swing.JRadioButtonMenuItem(languageEntry.getValue());
            languageItem.setSelected(languageCode.equalsIgnoreCase(currentLang));
            languageItem.addActionListener(e -> {
                promptAndSwitchLanguage(languageCode);
            });
        ...
        if (! hideAbout) {
            menuItem = new JMenuItem(strings.getString("ui.menu.about"));
            menuItem.setMnemonic('a');
            menuItem.addActionListener(e -> {
    ...
    private void addCeiling() {
        ...
        if (! dialog.isCancelled()) {
            ...
            Dimension ceiling = ProgressDialog.executeTask(this, new ProgressTask<Dimension>() {
                @Override
                public String getName() {
                    return strings.getString("creating.ceiling.dimension");
                }
    ...
    private void removeCeiling() {
        ...
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeDimensionPrefix") + ' ' + org.pepsoft.worldpainter.WPI18n.dimensionName(ceiling) + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeDimensionSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmPrefix") + ' ' + org.pepsoft.worldpainter.WPI18n.dimensionName(ceiling) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.deletionSuffix"), YES_NO_OPTION) == YES_OPTION) {
            ...
            showInfo(this, MessageFormat.format(strings.getString("dimension.deleted.success.message"), ceiling.getName()), strings.getString("success"));
        }
    }
...
//        toolBar.add(ACTION_SHOW_HELP_PICKER);
    ...
    private void addStatisticsTo(MenuElement menuElement, @NonNls final String key, final EventLogger eventLogger) {
        if ((menuElement instanceof JMenuItem) && (! (menuElement instanceof JMenu))) {
            ...
            if (((! (menuItem.getAction() instanceof BetterAction)) || (! ((BetterAction) menuItem.getAction()).isLogEvent()))
                    && (! Objects.equals(menuItem.getText(), "Existing Minecraft map..."))
                    && (! Objects.equals(menuItem.getText(), "Merge World..."))) {
    ...
    private void addNether() {
        ...
        if (! dialog.isCancelled()) {
            ...
            Dimension nether = ProgressDialog.executeTask(this, new ProgressTask<Dimension>() {
                @Override
                public String getName() {
                    return strings.getString("creating.nether");
                }
    ...
    private void removeNether() {
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeNetherDimension"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmNetherDeletion.title"), YES_NO_OPTION) == YES_OPTION) {
            ...
            showInfo(this, strings.getString("nether.dimension.deleted.success.message"), strings.getString("success"));
        }
    }
    ...
    private void addEnd() {
        ...
        if (! dialog.isCancelled()) {
            ...
            Dimension end = ProgressDialog.executeTask(this, new ProgressTask<Dimension>() {
                @Override
                public String getName() {
                    return strings.getString("creating.end");
                }
    ...
    private void removeEnd() {
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeEndDimension"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmEndDeletion.title"), YES_NO_OPTION) == YES_OPTION) {
            ...
            showInfo(this, strings.getString("end.dimension.deleted.success.message"), strings.getString("success"));
        }
    }
    ...
    private void addMaster() {
        ...
        if (! dialog.isCancelled()) {
            ...
            Dimension master = ProgressDialog.executeTask(this, new ProgressTask<Dimension>() {
                @Override
                public String getName() {
                    return strings.getString("creating.master.dimension");
                }
    ...
    private void removeMaster() {
        ...
        if (showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeDimensionPrefix") + ' ' + org.pepsoft.worldpainter.WPI18n.dimensionName(master) + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeDimensionSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmPrefix") + ' ' + org.pepsoft.worldpainter.WPI18n.dimensionName(master) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.deletionSuffix"), YES_NO_OPTION) == YES_OPTION) {
            ...
            showInfo(this, MessageFormat.format(strings.getString("dimension.deleted.success.message"), master.getName()), strings.getString("success"));
        }
    }
...
//            }
    ...
    private List<Component> createLayerRow(final Layer layer, final boolean createShowCheckbox, final boolean createSoloCheckbox, final JComponent layerComponent) {
        ...
        if (createSoloCheckbox) {
            ...
            soloCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.html.htmlCheckToShow"));
    ...
    private JToggleButton createTerrainButton(final Terrain terrain) {
        ...
        button.setToolTipText(org.pepsoft.worldpainter.WPI18n.terrainTooltip(terrain));
        button.addItemListener(event -> {
            if (event.getStateChange() == ItemEvent.SELECTED) {
    ...
    private boolean importCustomMaterials() {
        if (dimension == null) {
            ...
            showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.allCustomTerrainSlotsInUse"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.noFreeSlots.title"), ERROR_MESSAGE);
            return false;
        }
        ...
        if (customMaterials != null) {
            if (getConfiguredCustomMaterialCount() + customMaterials.length > CUSTOM_TERRAIN_COUNT) {
                showWarning(this,
                        java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.app.tooManyCustomTerrains.message"), CUSTOM_TERRAIN_COUNT - getConfiguredCustomMaterialCount()),
                        org.pepsoft.worldpainter.WPI18n.s("ui.app.tooManyCustomTerrains.title"));
                return false;
            }
            int nextIndex = 0;
    ...
    private void removeCustomMaterial(int index) {
        ...
        Set<Terrain> allTerrains = ProgressDialog.executeTask(this, strings.getString("checking.whether.terrain.is.in.use"), () -> world.getDimensions().stream()
                .parallel()
                .flatMap(dim -> dim.getAllTerrains().parallelStream())
                .collect(toSet()), NOT_CANCELABLE);
        if (allTerrains.contains(customTerrain)) {
            Toolkit.getDefaultToolkit().beep();
            JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.frag.customTerrainQuotePrefix") + name + org.pepsoft.worldpainter.WPI18n.s("ui.message.terrainInUseOnWorldSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.terrainInUse.title"), ERROR_MESSAGE);
            return;
        }
        ...
        for (CustomLayer layer: allLayers) {
            if ((layer instanceof CombinedLayer) && (((CombinedLayer) layer).getTerrain() == customTerrain)) {
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.frag.customTerrainQuotePrefix") + name + org.pepsoft.worldpainter.WPI18n.s("ui.message.terrainInCombinedLayerSuffix") + layer.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.message.terrainInLayerRemoveSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.terrainInUse.title"), ERROR_MESSAGE);
                return;
            }
        }

        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.deleteCustomTerrainPrefix") + name + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.operationCannotUndoSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmDeletion.title"), YES_NO_OPTION) == YES_OPTION) {
            ...
            showInfo(this, MessageFormat.format(strings.getString("custom.terrain.0.deleted.message"), name), strings.getString("custom.terrain.deleted"));
        }
    }
    ...
    private void exportImage() {
        ...
        if (! imageFitsInJavaArray(dimension)) {
            beepAndShowError(this, MessageFormat.format(strings.getString("dimension.too.large.export.image.message"), INT_NUMBER_FORMAT.format(Integer.MAX_VALUE)), strings.getString("dimension.too.large"));
            return;
        }
        ...
        File selectedFile = FileUtils.selectFileForSave(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.exportImageFile"), new File(defaultname), new FileFilter() {
            @Override
            public boolean accept(File f) {
                if (f.isDirectory()) {
                    return true;
        ...
        if (selectedFile != null) {
            ...
            if (! ProgressDialog.executeTask(App.this, new ProgressTask<Boolean>() {
                ...
                showMessageDialog(App.this, MessageFormat.format(strings.getString("format.0.not.supported"), type), strings.getString("information"), INFORMATION_MESSAGE);
            }
        }
    }
    ...
    private void exportHeightMap(HeightMapExporter.Format format) {
        ...
        if (! imageFitsInJavaArray(dimension)) {
            beepAndShowError(this, MessageFormat.format(strings.getString("dimension.too.large.export.height.map.message"), INT_NUMBER_FORMAT.format(Integer.MAX_VALUE)), strings.getString("dimension.too.large"));
            return;
        }
        ...
        File selectedFile = FileUtils.selectFileForSave(App.this, (format == INTEGER_HIGH_RESOLUTION) ? org.pepsoft.worldpainter.WPI18n.s("ui.dlg.exportHighResHeightMap") : org.pepsoft.worldpainter.WPI18n.s("ui.dlg.exportHeightMap"), defaultFile, new FileFilter() {
            @Override
            public boolean accept(File f) {
                if (f.isDirectory()) {
                    return true;
        ...
        if (selectedFile != null) {
            ...
            if (p != -1) {
                ...
                beepAndShowError(App.this, strings.getString("no.filename.extension.specified"), strings.getString("missing.extension"));
                return;
            }
            if (selectedFile.exists()) {
                if (showConfirmDialog(App.this, strings.getString("the.file.already.exists"), strings.getString("overwrite.file"), YES_NO_OPTION) != YES_OPTION) {
            ...
            if (! ImageIO.getImageWritersBySuffix(type).hasNext()) {
                beepAndShowError(this, MessageFormat.format(strings.getString("filename.extension.0.not.supported.image.type"), type), strings.getString("unsupported.format"));
                return;
            }
            ...
            if (ProgressDialog.executeTask(App.this, new ProgressTask<Boolean>() {
                ...
                MessageUtils.showInfo(App.this, MessageFormat.format(strings.getString("dimension.exported.to.0.n1"), selectedFile.getName(), heightMapExporter.getFormatDescription()), strings.getString("export.succeeded"));
            } else {
                beepAndShowError(App.this, MessageFormat.format(strings.getString("format.0.not.supported"), type), strings.getString("unsupported.format"));
            }
        }
    }
    ...
    void importLayers(String paletteName, Function<Layer, Boolean> filter) {
        ...
        final File[] selectedFiles = FileUtils.selectFilesForOpen(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectLayerFiles"), layerDirectory, new FileFilter() {
            @Override
            public boolean accept(File f) {
        ...
        if (selectedFiles != null) {
            ...
            for (File selectedFile: selectedFiles) {
                try {
                    try (ObjectInputStream in = new ObjectInputStream(new GZIPInputStream(new BufferedInputStream(new FileInputStream(selectedFile))))) {
                        ...
                        for (Layer existingLayer: customLayerController.getCustomLayers()) {
                            if (layer.equals(existingLayer)) {
                                beepAndShowError(this, strings.getString("that.layer.already.present"), strings.getString("layer.already.present"));
                                return;
                            }
                        }
                        if ((filter != null) && (! filter.apply(layer))) {
                            beepAndShowError(this, strings.getString("layer.type.not.supported.for.dimension"), strings.getString("inapplicable.layer.type"));
                            return;
                        }
                        if (! layer.isExportableToFile()) {
                            beepAndShowError(this, strings.getString("that.layer.is.not.importable"), strings.getString("unimportable.layer"));
                            return;
                        }
                        if (paletteName != null) {
                    ...
                    beepAndShowError(this, strings.getString("specified.path.not.file"), strings.getString("nonexistent.file"));
                    return;
                } catch (IOException e) {
                    logger.error("I/O error while loading file " + selectedFile, e);
                    beepAndShowError(this, strings.getString("io.error.or.invalid.layer.file"), strings.getString("io.error.or.invalid.file"));
                    return;
                } catch (ClassNotFoundException e) {
                    logger.error("Class not found exception while loading file " + selectedFile, e);
                    beepAndShowError(this, strings.getString("specified.file.not.valid.layer.file"), strings.getString("invalid.file"));
                    return;
    ...
    void importCustomItemsFromWorld(CustomItemsTreeModel.ItemType itemType, Function<Layer, Boolean> filter) {
        ...
        final File selectedFile = FileUtils.selectFileForOpen(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectWorldPainterWorld"), dir,
                new FileFilter() {
                    @Override
                    public boolean accept(File f) {
                        return f.isDirectory()
        ...
        if (selectedFile != null) {
            ...
            if (CustomItemsTreeModel.hasCustomItems(selectedWorld, itemType)) {
                ...
                if (! dialog.isCancelled()) {
                    ...
                    for (Object selectedItem: dialog.getSelectedItems()) {
                        if (selectedItem instanceof CustomLayer) {
                            ...
                            if (existingCustomLayers.contains(selectedItem)) {
                                errors.append(MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.error.layerAlreadyExists"), ((CustomLayer) selectedItem).getName())).append('\n');
                            } else if ((filter != null) && (! filter.apply((CustomLayer) selectedItem))) {
                                errors.append(MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.error.layerNotSupportedForDimension"), ((CustomLayer) selectedItem).getName())).append('\n');
                                showError = true;
                            } else {
                            ...
                            if (index == -1) {
                                errors.append(MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.error.noFreeTerrainSlots"), customMaterial.getName())).append('\n');
                                showError = true;
                                continue;
                            }
                            customMaterial = MixedMaterialManager.getInstance().register(customMaterial);
                            ...
                            if (! customBiomeManager.addCustomBiome(null, customBiome)) {
                                errors.append(MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.error.biomeIdInUse"), customBiome.getId(), customBiome.getName())).append('\n');
                                showError = true;
                            } else {
                                refreshView = true;
                            }
                    ...
                    if (errors.length() > 0) {
                        JOptionPane.showMessageDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.notAllItemsImportedPrefix") + errors, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.notAllItemsImported.title"), showError ? JOptionPane.ERROR_MESSAGE : JOptionPane.WARNING_MESSAGE);
                    }
                }
            } else {
                final String what;
                switch (itemType) {
                    case ALL:
                        what = org.pepsoft.worldpainter.WPI18n.s("ui.app.customItems.all");
                        break;
                    case BIOME:
                        what = org.pepsoft.worldpainter.WPI18n.s("ui.app.customItems.biomes");
                        break;
                    case LAYER:
                        what = org.pepsoft.worldpainter.WPI18n.s("ui.app.customItems.layers");
                        break;
                    case TERRAIN:
                        what = org.pepsoft.worldpainter.WPI18n.s("ui.app.customItems.terrains");
                        break;
                    default:
                        throw new InternalError();
                }
                showWarning(this,
                        java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.app.noCustomItems.message"), what),
                        org.pepsoft.worldpainter.WPI18n.s("ui.app.noCustomItems.title"));
            }
        }
    }
    ...
    private final BetterAction ACTION_IMPORT_MAP = new BetterAction("importMinecraftMap", strings.getString("existing.minecraft.map") + "...", false) {
        {
            ...
            setShortDescription(org.pepsoft.worldpainter.WPI18n.s("ui.action.importMinecraftMap.tooltip"));
        }
    ...
    private final BetterAction ACTION_MERGE_WORLD = new BetterAction("mergeWorld", strings.getString("merge.world") + "...", false) {
        {
            ...
            setShortDescription(org.pepsoft.worldpainter.WPI18n.s("ui.action.mergeWorld.tooltip"));
        }
...
//            view.moveTo(location);
    ...
    private final BetterAction ACTION_ROTATE_WORLD = new BetterAction("rotate", strings.getString("ui.menu.rotate") + "...", ICON_ROTATE_WORLD) {
        {
    ...
    private final BetterAction ACTION_SHIFT_WORLD = new BetterAction("shift", org.pepsoft.worldpainter.WPI18n.s("ui.action.shiftWorld"), ICON_SHIFT_WORLD) {
        {
            setShortDescription(org.pepsoft.worldpainter.WPI18n.s("ui.action.shiftWorld.tooltip"));
        }
    ...
    private final BetterAction ACTION_SCALE_WORLD = new BetterAction("scale", org.pepsoft.worldpainter.WPI18n.s("ui.action.scaleWorld"), ICON_SCALE_WORLD) {
        {
            setShortDescription(org.pepsoft.worldpainter.WPI18n.s("ui.action.scaleWorld.tooltip"));
        }
    ...
    private final BetterAction ACTION_RESET_DOCKS = new BetterAction("resetDockLayout", org.pepsoft.worldpainter.WPI18n.s("ui.action.resetDocks")) {
        @Override
        protected void performAction(ActionEvent e) {
            DesktopUtils.beep();
            if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.resetWorkspace"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmWorkspaceReset.title"), YES_NO_OPTION) == YES_OPTION) {
                dockingManager.resetToDefault();
                Configuration config = Configuration.getInstance();
    ...
    private final BetterAction ACTION_RESET_ALL_DOCKS = new BetterAction("resetAllDockLayout", org.pepsoft.worldpainter.WPI18n.s("ui.action.resetAllDocks")) {
        @Override
        protected void performAction(ActionEvent e) {
            DesktopUtils.beep();
            if (JOptionPane.showConfirmDialog(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.resetAllWorkspaces"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmWorkspaceReset.title"), YES_NO_OPTION) == YES_OPTION) {
                dockingManager.resetToDefault();
                Configuration config = Configuration.getInstance();
                config.setDefaultJideLayoutData(null);
    ...
    private final BetterAction ACTION_LOAD_LAYOUT = new BetterAction("loadDockLayout", org.pepsoft.worldpainter.WPI18n.s("ui.action.loadLayout")) {
        @Override
        protected void performAction(ActionEvent e) {
            Configuration config = Configuration.getInstance();
            if (config.getDefaultJideLayoutData() != null) {
    ...
    private final BetterAction ACTION_SAVE_LAYOUT = new BetterAction("resetDocks", org.pepsoft.worldpainter.WPI18n.s("ui.action.saveLayout")) {
        @Override
        protected void performAction(ActionEvent e) {
            Configuration config = Configuration.getInstance();
            config.setDefaultJideLayoutData(dockingManager.getLayoutRawData());
            ACTION_LOAD_LAYOUT.setEnabled(true);
            showInfo(App.this, org.pepsoft.worldpainter.WPI18n.s("ui.app.workspaceLayoutSaved.message"), org.pepsoft.worldpainter.WPI18n.s("ui.app.workspaceLayoutSaved.title"));
        }
    };

    private final BetterAction ACTION_SWITCH_TO_FROM_CEILING = new BetterAction("switchCeiling", org.pepsoft.worldpainter.WPI18n.s("ui.action.switchCeiling")) {
        {
    ...
    private final BetterAction ACTION_SWITCH_TO_FROM_MASTER = new BetterAction("switchMaster", org.pepsoft.worldpainter.WPI18n.s("ui.action.switchMaster")) {
        {
    ...
    private final BetterAction ACTION_SHOW_CUSTOM_TERRAIN_POPUP = new BetterAction("showCustomTerrainMenu", null, loadScaledIcon("plus")) {
        {
            setShortDescription(org.pepsoft.worldpainter.WPI18n.s("ui.customTerrain.add.tooltip"));
        }
    ...
    public static final Image ICON = IconUtils.loadScaledImage("org/pepsoft/worldpainter/icons/worldpainter-languages-icon.png");
    ...
    private static final ResourceBundle strings = ResourceBundle.getBundle("org.pepsoft.worldpainter.resources.strings", java.util.Locale.getDefault(), org.pepsoft.worldpainter.Utf8Control.INSTANCE); // NOI18N
