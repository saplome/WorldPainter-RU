...
public class CustomLayersTableModel implements TableModel {
    ...
    public String getColumnName(int columnIndex) {
        return WPI18n.s(COLUMN_NAME_KEYS[columnIndex]);
    }
    ...
    private static final String[]   COLUMN_NAME_KEYS = {"ui.col.layer",     "ui.col.palette", "ui.col.type", "ui.export.verb"};
    private static final Class<?>[] COLUMN_TYPES     = {CustomLayer.class,  String.class,     String.class,  Boolean.class};

    public static final CustomLayer FIRST_PASS_HEADER = new CustomLayer(WPI18n.s("ui.customLayers.firstExportPass"), null, null, -1, null) {};
    public static final CustomLayer SECOND_PASS_HEADER = new CustomLayer(WPI18n.s("ui.customLayers.secondExportPass"), null, null, -1, null) {};
}
