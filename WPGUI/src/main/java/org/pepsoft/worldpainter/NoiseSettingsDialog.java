...
public class NoiseSettingsDialog extends WorldPainterDialog implements ChangeListener {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.adjust_noise_settings"));
        setResizable(false);

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.adjust.the.noise.settings.cfe5f18eec"));
