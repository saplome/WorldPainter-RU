...
//                world = WorldFactory.createFancyWorld(config, new Random().nextLong());
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            // RU: localize standard Swing dialogs (file chooser, colour chooser, option pane)
            if ("ru".equals(java.util.Locale.getDefault().getLanguage())) {
                org.pepsoft.worldpainter.WPI18n.installSwingRussianDefaults();
            }
