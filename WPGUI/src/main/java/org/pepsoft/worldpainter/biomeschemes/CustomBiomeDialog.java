...
public class CustomBiomeDialog extends WorldPainterDialog {
    ...
    public CustomBiomeDialog(Window parent, CustomBiome customBiome, boolean _new, Platform platform) {
        ...
        if (platform.capabilities.contains(NAMED_BIOMES)) {
            remove(jLabel2);
            remove(spinnerID);
            jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.id"));
            if (_new) {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.configureCustomBiome.title"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.configure.configureTheCustomBiome"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.id"));
