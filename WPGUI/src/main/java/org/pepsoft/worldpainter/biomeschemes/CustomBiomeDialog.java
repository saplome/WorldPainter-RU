...
public class CustomBiomeDialog extends WorldPainterDialog {
    ...
    public CustomBiomeDialog(Window parent, CustomBiome customBiome, boolean _new, Platform platform) {
        ...
        if (platform.capabilities.contains(NAMED_BIOMES)) {
            remove(jLabel2);
            remove(spinnerID);
            jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.id.e0f0b0564d"));
            if (_new) {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.configure_custom_biome"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.configure.the.custom.biome.41c080e2c7"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.id.e0f0b0564d"));
