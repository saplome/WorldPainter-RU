...
public class Palette {
    Palette(String name, List<Component> buttonComponents, PaletteManager paletteManager) {
        ...
        editButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.edit.palette.name.and.66129fec30"));
        ...
        showCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.uncheck.to.hide.all.cb38b8ade4"));
        showCheckBox.setSelected(true);
        showCheckBox.addActionListener(e -> setShow(showCheckBox.isSelected()));
        soloCheckBox = new JCheckBox();
        soloCheckBox.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.check.to.show.9d2a33434e"));
