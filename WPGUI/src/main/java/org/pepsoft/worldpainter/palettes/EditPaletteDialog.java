...
public class EditPaletteDialog extends WorldPainterDialog {
        ...
        if (! newName.equals(palette.getName())) {
            ...
            if ((existingPalette != null) && (existingPalette != palette)) {
                beepAndShowError(this,
                        java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.palette.nameInUse.message"), newName),
                        org.pepsoft.worldpainter.WPI18n.s("ui.palette.nameInUse.title"));
                return false;
            }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.edit_palette"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.layer.order.f17de6e6b1"));
        ...
        buttonTop.setText(org.pepsoft.worldpainter.WPI18n.s("wp.top.a4ffdcf0dc"));
        buttonTop.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.move.the.selected.layers.bf8e306a4b"));
        ...
        buttonUp.setText(org.pepsoft.worldpainter.WPI18n.s("wp.up.258f49887e"));
        buttonUp.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.move.the.selected.layers.58fe9489b8"));
        ...
        buttonDown.setText(org.pepsoft.worldpainter.WPI18n.s("wp.down.08a38277b0"));
        buttonDown.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.move.the.selected.layers.1650795873"));
        ...
        buttonBottom.setText(org.pepsoft.worldpainter.WPI18n.s("wp.bottom.2ad9d63b69"));
        buttonBottom.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.move.the.selected.layers.daea78f9f0"));
        ...
        buttonSort.setText(org.pepsoft.worldpainter.WPI18n.s("wp.sort.6b46ae4842"));
        buttonSort.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.sort.all.the.layers.78e4a098e1"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.hold.shift.to.select.9735605364"));
