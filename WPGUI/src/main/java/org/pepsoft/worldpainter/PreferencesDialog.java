...
public class PreferencesDialog extends WorldPainterDialog {
    ...
    private void loadSettings() {
        ...
        try {
            ...
            if (maxThreadCountFixed) {
                ...
                radioButtonThreadCountAuto.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.overridden.by.org.pepsoft.854755fe88"));
                radioButtonThreadCountManual.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.overridden.by.org.pepsoft.854755fe88"));
                spinnerManualThreadCount.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.overridden.by.org.pepsoft.854755fe88"));
    ...
    private void editDefaultExportSettings() {
        ...
        if (platformDefaultExportSettings != null) {
            ...
            dialog.setTitle(org.pepsoft.worldpainter.WPI18n.s("wp.configure.default.post.processing.e5d57c4c15"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.preferences"));

        checkBoxPing.setSelected(true);
        checkBoxPing.setText(org.pepsoft.worldpainter.WPI18n.s("wp.send.usage.information.to.5d5348ebd7"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.note.that.the.information.3d8f5d55a0"));

        jLabel4.setFont(jLabel4.getFont().deriveFont((jLabel4.getFont().getStyle() | java.awt.Font.ITALIC)));
        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.information.and.will.never.655e1da741"));

        checkBoxCheckForUpdates.setSelected(true);
        checkBoxCheckForUpdates.setText(org.pepsoft.worldpainter.WPI18n.s("wp.check.for.updates.on.94398894b3"));

        jLabel20.setText(org.pepsoft.worldpainter.WPI18n.s("wp.no.of.backups.of.23af5d6d9f"));

        spinnerWorldBackups.setModel(new javax.swing.SpinnerNumberModel(3, 0, null, 1));

        jLabel30.setText(org.pepsoft.worldpainter.WPI18n.s("wp.visual.theme.812fc11939"));
        ...
        jLabel32.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.em.effective.after.fa9da4a4bf"));

        checkBoxAutoSave.setSelected(true);
        checkBoxAutoSave.setText(org.pepsoft.worldpainter.WPI18n.s("wp.enable.autosave.505cbec0cf"));
        ...
        jLabel45.setText(org.pepsoft.worldpainter.WPI18n.s("wp.guard.time.138a36bc70"));

        spinnerAutoSaveGuardTime.setModel(new javax.swing.SpinnerNumberModel(10, 1, 999, 1));

        jLabel46.setText(org.pepsoft.worldpainter.WPI18n.s("wp.autosave.interval.8f04a6994d"));

        spinnerAutoSaveInterval.setModel(new javax.swing.SpinnerNumberModel(300, 1, 9999, 1));

        jLabel47.setText(org.pepsoft.worldpainter.WPI18n.s("wp.seconds.783e8e29e6"));

        jLabel48.setText(org.pepsoft.worldpainter.WPI18n.s("wp.seconds.783e8e29e6"));

        checkBoxUndo.setSelected(true);
        checkBoxUndo.setText(org.pepsoft.worldpainter.WPI18n.s("wp.enable.undo.cb26a5adbc"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.undo.levels.001d31f756"));

        spinnerUndoLevels.setModel(new javax.swing.SpinnerNumberModel(25, 1, 999, 1));

        jLabel2.setLabelFor(sliderUIScale);
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.ui.scale.5eb1649e19"));
        ...
        radioButtonUIScaleAuto.setText(org.pepsoft.worldpainter.WPI18n.s("wp.auto.585d5fb733"));
        ...
        radioButtonUIScaleManual.setText(org.pepsoft.worldpainter.WPI18n.s("wp.manual.a11469c6b7"));
        ...
        jLabel49.setText(org.pepsoft.worldpainter.WPI18n.s("wp.backup.settings.39f9a6c8ee"));

        jLabel50.setText(org.pepsoft.worldpainter.WPI18n.s("wp.minimum.free.space.on.493f1bd9c6"));

        spinnerFreeSpaceForMaps.setModel(new javax.swing.SpinnerNumberModel(2, 1, 999, 1));

        jLabel51.setText(org.pepsoft.worldpainter.WPI18n.s("wp.gb.79cba11854"));

        checkBoxAutoDeleteBackups.setSelected(true);
        checkBoxAutoDeleteBackups.setText(org.pepsoft.worldpainter.WPI18n.s("wp.offer.to.delete.old.075695d07b"));
        ...
        buttonCleanUpBackupsNow.setText(org.pepsoft.worldpainter.WPI18n.s("wp.clean.up.backups.now.09a0191711"));
        buttonCleanUpBackupsNow.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.delete.backups.oldest.first.9207a83e35"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.configure.your.default.settings.6d23fd257c"));

        jLabel18.setFont(jLabel18.getFont().deriveFont((jLabel18.getFont().getStyle() | java.awt.Font.ITALIC)));
        jLabel18.setText(org.pepsoft.worldpainter.WPI18n.s("wp.note.that.changes.to.e6e0038eb4"));

        jLabel6.setFont(jLabel6.getFont().deriveFont((jLabel6.getFont().getStyle() | java.awt.Font.ITALIC)));
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.default.view.settings.4fe09f29a4"));

        checkBoxGrid.setText(org.pepsoft.worldpainter.WPI18n.s("wp.grid.enabled.188d1bb504"));

        checkBoxContours.setSelected(true);
        checkBoxContours.setText(org.pepsoft.worldpainter.WPI18n.s("wp.contour.lines.enabled.4e6e19270a"));

        checkBoxViewDistance.setText(org.pepsoft.worldpainter.WPI18n.s("wp.view.distance.enabled.442dd5ed97"));

        jLabel22.setText(org.pepsoft.worldpainter.WPI18n.s("wp.light.direction.3c5686c5f7"));
        ...
        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.grid.size.eac3808d28"));

        spinnerGrid.setModel(new javax.swing.SpinnerNumberModel(128, 2, 999, 1));

        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("wp.separation.7db68df3dd"));

        spinnerContours.setModel(new javax.swing.SpinnerNumberModel(10, 2, 999, 1));

        checkBoxWalkingDistance.setText(org.pepsoft.worldpainter.WPI18n.s("wp.walking.distance.enabled.92e5aafa2e"));

        jLabel26.setText(org.pepsoft.worldpainter.WPI18n.s("wp.maximum.brush.size.17e612374c"));
        ...
        jLabel27.setText(org.pepsoft.worldpainter.WPI18n.s("wp.warning.large.brush.sizes.669dfd0d45"));

        jLabel9.setFont(jLabel9.getFont().deriveFont((jLabel9.getFont().getStyle() | java.awt.Font.ITALIC)));
        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.default.world.settings.c96a17e218"));

        jLabel10.setLabelFor(spinnerWidth);
        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("wp.dimensions.adcb4df47a"));
        ...
        jLabel11.setText(org.pepsoft.worldpainter.WPI18n.s("wp.x.9dd4e46126"));
        ...
        jLabel19.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.e734964953"));

        jLabel12.setLabelFor(comboBoxHeight);
        jLabel12.setText(org.pepsoft.worldpainter.WPI18n.s("wp.height.e933dc24fb"));
        ...
        jLabel13.setText(org.pepsoft.worldpainter.WPI18n.s("wp.topography.37d50294d9"));

        buttonGroup1.add(radioButtonHilly);
        radioButtonHilly.setSelected(true);
        radioButtonHilly.setText(org.pepsoft.worldpainter.WPI18n.s("wp.hilly.8f5ebcb52e"));
        ...
        jLabel23.setText(org.pepsoft.worldpainter.WPI18n.s("wp.height.5163f65122"));

        spinnerRange.setModel(new javax.swing.SpinnerNumberModel(20, 1, 255, 1));

        jLabel24.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.b54d5645a6"));
        ...
        radioButtonFlat.setText(org.pepsoft.worldpainter.WPI18n.s("wp.flat.745e3db6a7"));
        ...
        checkBoxCircular.setText(org.pepsoft.worldpainter.WPI18n.s("wp.circular.world.c671214187"));
        ...
        jLabel14.setText(org.pepsoft.worldpainter.WPI18n.s("wp.level.07ad815187"));

        spinnerGroundLevel.setModel(new javax.swing.SpinnerNumberModel(58, 1, 255, 1));

        jLabel15.setText(org.pepsoft.worldpainter.WPI18n.s("wp.water.level.3cd4b936aa"));
        ...
        checkBoxLava.setText(org.pepsoft.worldpainter.WPI18n.s("wp.lava.instead.of.water.9a61400b45"));

        checkBoxBeaches.setSelected(true);
        checkBoxBeaches.setText(org.pepsoft.worldpainter.WPI18n.s("wp.beaches.5053eab76b"));
        ...
        jLabel16.setText(org.pepsoft.worldpainter.WPI18n.s("wp.surface.material.532d489326"));
        ...
        checkBoxExtendedBlockIds.setText(org.pepsoft.worldpainter.WPI18n.s("wp.extended.block.id.s.0f21d339c0"));

        buttonReset.setText(org.pepsoft.worldpainter.WPI18n.s("wp.reset.33f952105a"));
        ...
        labelTerrainAndLayerSettings.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.u.configure.default.9848f34da3"));
        ...
        jLabel17.setText(org.pepsoft.worldpainter.WPI18n.s("wp.default.export.settings.743ca3b5b3"));

        checkBoxChestOfGoodies.setText(org.pepsoft.worldpainter.WPI18n.s("wp.include.chest.of.goodies.85bc41cb70"));

        jLabel28.setText(org.pepsoft.worldpainter.WPI18n.s("wp.world.type.893bc52f47"));
        ...
        checkBoxStructures.setText(org.pepsoft.worldpainter.WPI18n.s("wp.structures.2dec5ee9db"));

        jLabel29.setText(org.pepsoft.worldpainter.WPI18n.s("wp.mode.1ee1c44c2d"));
        ...
        checkBoxCheats.setText(org.pepsoft.worldpainter.WPI18n.s("wp.allow.cheats.7de7d7670b"));

        jLabel52.setText(org.pepsoft.worldpainter.WPI18n.s("wp.map.format.980a0dbfbe"));
        ...
        labelEditExportSettingsLink.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.u.configure.default.4baf6eee1f"));
        ...
        checkBoxResourcesEverywhere.setText(org.pepsoft.worldpainter.WPI18n.s("wp.resources.everywhere.d1bbcc043c"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.pepsoft.worldpainter.WPI18n.s("wp.hardware.acceleration.fe65647a1f")));

        jLabel31.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.select.a.method.0596eff772"));

        buttonGroup2.add(radioButtonAccelDefault);
        radioButtonAccelDefault.setText(org.pepsoft.worldpainter.WPI18n.s("wp.default.7a1920d611"));

        buttonGroup2.add(radioButtonAccelDirect3D);
        radioButtonAccelDirect3D.setText(org.pepsoft.worldpainter.WPI18n.s("wp.direct.d.e5054d13a1"));

        buttonGroup2.add(radioButtonAccelOpenGL);
        radioButtonAccelOpenGL.setText(org.pepsoft.worldpainter.WPI18n.s("wp.opengl.760716b590"));

        buttonGroup2.add(radioButtonAccelQuartz);
        radioButtonAccelQuartz.setText(org.pepsoft.worldpainter.WPI18n.s("wp.quartz.8f116d732e"));

        buttonGroup2.add(radioButtonAccelXRender);
        radioButtonAccelXRender.setText(org.pepsoft.worldpainter.WPI18n.s("wp.xrender.da043e9337"));

        buttonGroup2.add(radioButtonAccelUnaccelerated);
        radioButtonAccelUnaccelerated.setText(org.pepsoft.worldpainter.WPI18n.s("wp.unaccelerated.c59cd7bda1"));

        jLabel33.setText(org.pepsoft.worldpainter.WPI18n.s("wp.disable.all.hardware.acceleration.09b062dbd6"));

        jLabel34.setText(org.pepsoft.worldpainter.WPI18n.s("wp.uses.the.xrender.x.ef387e7998"));

        jLabel36.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.em.effective.after.fa9da4a4bf"));

        jLabel37.setText(org.pepsoft.worldpainter.WPI18n.s("wp.uses.the.opengl.rendering.5fbb77a16e"));

        jLabel38.setText(org.pepsoft.worldpainter.WPI18n.s("wp.uses.the.direct.d.03d05a2770"));

        jLabel39.setText(org.pepsoft.worldpainter.WPI18n.s("wp.uses.java.s.default.3a18cc1c2c"));

        jLabel35.setText(org.pepsoft.worldpainter.WPI18n.s("wp.uses.apple.s.quartz.1e7c4106db"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.pepsoft.worldpainter.WPI18n.s("wp.overlay.scaling.and.painting.c86c361e02")));

        jLabel40.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.select.a.method.91a0e7c867"));

        jLabel41.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.em.effective.after.5f7ea083aa"));

        buttonGroup3.add(radioButtonOverlayScaleOnLoad);
        radioButtonOverlayScaleOnLoad.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.on.load.4b09489f49"));

        buttonGroup3.add(radioButtonOverlayOptimiseOnLoad);
        radioButtonOverlayOptimiseOnLoad.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.optimise.on.load.3d21c407c6"));
        ...
        radioButtonOverlayScaleOnPaint.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.on.paint.fc41e4a03f"));

        jLabel42.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.optimises.the.image.56d5f9f06f"));

        jLabel43.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.scales.and.optimises.c70c4fe66c"));

        jLabel44.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.does.not.optimise.bccc34f23b"));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(org.pepsoft.worldpainter.WPI18n.s("wp.exporting.58946eb6fa")));

        jLabel53.setText(org.pepsoft.worldpainter.WPI18n.s("wp.maximum.thread.count.e3cc51a335"));

        buttonGroup5.add(radioButtonThreadCountAuto);
        radioButtonThreadCountAuto.setText(org.pepsoft.worldpainter.WPI18n.s("wp.manage.automatically.d5cbf6b4e3"));
        ...
        radioButtonThreadCountManual.setText(org.pepsoft.worldpainter.WPI18n.s("wp.manual.a11469c6b7"));
        ...
        jLabel54.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.i.effective.on.88fc06a156"));
    ...
    private void buttonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonResetActionPerformed
        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.b7a5f22319"), org.pepsoft.worldpainter.WPI18n.s("ui.h.03b02c0892"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            final Configuration config = Configuration.getInstance();
    ...
    private void buttonModePresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModePresetActionPerformed
        String editedGeneratorOptions = JOptionPane.showInputDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.143300df73"), generatorOptions);
