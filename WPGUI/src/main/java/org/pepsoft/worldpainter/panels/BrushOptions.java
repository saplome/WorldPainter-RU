...
public class BrushOptions extends javax.swing.JPanel implements Observer {
    ...
    private JMenu createObjectSelectionMenu(final String descriptor, final ObjectSelectionListener listener, final boolean addAnother, final Object currentSelection) {
        ...
        eyedropperItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.select.a.paint.from.eb6bfe8337"));
        final App app = App.getInstance();
        ...
        final JMenu layerMenu = new JMenu(org.pepsoft.worldpainter.WPI18n.s("ui.359b71e88f"));
        ...
        if ((! addAnother) && (currentSelection != null)) {
            ...
            subMenu.setText(org.pepsoft.worldpainter.WPI18n.s("wp.add.another.beda345b21"));
    ...
    private JMenu breakUpLongMenus(JMenu menu, int maxLength) {
        if (menu.getMenuComponentCount() > maxLength) {
            ...
            if (menu.getMenuComponentCount() > 0) {
                menu.setText(org.pepsoft.worldpainter.WPI18n.s("wp.more.d3da97e2d9"));
    ...
    private void initComponents() {
        ...
        checkBoxAbove.setText(org.pepsoft.worldpainter.WPI18n.s("wp.at.or.above.8dadd70c7f"));
        ...
        checkBoxBelow.setText(org.pepsoft.worldpainter.WPI18n.s("wp.at.or.below.c3d9b7cc06"));
        ...
        checkBoxReplace.setText(org.pepsoft.worldpainter.WPI18n.s("wp.only.on.3d3eec39b3"));
        ...
        checkBoxFeather.setText(org.pepsoft.worldpainter.WPI18n.s("wp.feather.82d65a5752"));
        ...
        checkBoxExceptOn.setText(org.pepsoft.worldpainter.WPI18n.s("wp.except.on.2688cd59ad"));
        ...
        checkBoxAboveSlope.setText(org.pepsoft.worldpainter.WPI18n.s("wp.above.55a9d6aa25"));
        ...
        checkBoxBelowSlope.setText(org.pepsoft.worldpainter.WPI18n.s("wp.below.6cede1cfde"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.degrees.18daee01fc"));

        checkBoxInSelection.setFont(checkBoxInSelection.getFont().deriveFont(checkBoxInSelection.getFont().getSize()-1f));
        checkBoxInSelection.setText(org.pepsoft.worldpainter.WPI18n.s("wp.inside.selection.3a69057b1d"));
        ...
        checkBoxOutsideSelection.setText(org.pepsoft.worldpainter.WPI18n.s("wp.outside.selection.0d9958ab9c"));
