...
public class InfoPanel extends javax.swing.JPanel implements MouseMotionListener {
    ...
    void updateInfo() {
        ...
        if (terrain != currentTerrain) {
            labelTerrain.setText(org.pepsoft.worldpainter.WPI18n.terrainName(terrain));
...
//        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.slope"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.layers"));

        labelSlope.setText(" ");

        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.coordinates"));

        labelCoords.setText(" ");

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.height"));

        labelHeight.setText(" ");

        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.m"));

        labelFluidType.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.fluid"));

        jLabel12.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.levelA5e6fd"));

        jLabel13.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.depth"));

        labelWaterLevel.setText(" ");

        jLabel15.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.m"));

        labelWaterDepth.setText(" ");

        jLabel17.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.m"));
        ...
        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.inSelection"));

        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.automatic"));
...
//    private final Timer updateTimer;
    ...
    static class LayerTableModel implements TableModel {
        ...
        public String getColumnName(int columnIndex) {
            return org.pepsoft.worldpainter.WPI18n.s(COLUMN_NAME_KEYS[columnIndex]);
        }
        ...
        private static final String[] COLUMN_NAME_KEYS = {"ui.col.layer", "ui.col.intensity"};
