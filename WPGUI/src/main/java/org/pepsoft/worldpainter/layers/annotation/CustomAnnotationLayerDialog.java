...
public class CustomAnnotationLayerDialog extends AbstractEditLayerDialog<CustomAnnotationLayer> {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.edit_custom_annotation_layer"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.a.custom.annotations.67d7434b7b"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.name.4e140ba723"));

        jTextField1.setColumns(15);

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.paint.d65951a421"));
