...
public class UndergroundPocketsDialog extends AbstractEditLayerDialog<UndergroundPocketsLayer> implements PropertyChangeListener {
    ...
    private void updateNameAndColour() {
        if (fieldName.isEnabled()) {
            if (radioButtonCustomMaterial.isSelected()) {
                ...
                if (terrain != null) {
                    fieldName.setText(org.pepsoft.worldpainter.WPI18n.terrainName(terrain));
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.configureUndergroundPockets.title"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.selectYourCustomMaterial"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("ui.col.paint"));
        ...
        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.occurrence"));
        ...
        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.scale"));

        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.levels"));
        ...
        radioButtonCustomMaterial.setText(org.pepsoft.worldpainter.WPI18n.s("ui.custom.customMaterial"));
