...
public class EditPaintDialog extends WorldPainterDialog {
    ...
    private void createColourButtons() {
        ...
        for (int ega = 0; ega < 16; ega++) {
            ...
            button.setToolTipText(org.pepsoft.worldpainter.WPI18n.colour(EGA_NAMES[ega]));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.edit_paint"));
        ...
        buttonSolidColour.setText(org.pepsoft.worldpainter.WPI18n.s("wp.make.solid.colour.d089660770"));
        buttonSolidColour.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.select.a.colour.6b88912b1d"));
        ...
        toggleButtonPencil.setSelected(true);
        toggleButtonPencil.setText(org.pepsoft.worldpainter.WPI18n.s("wp.pencil.b1e2171bb6"));
        toggleButtonPencil.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.left.click.to.c2239ffe66"));
        ...
        toggleButtonEraser.setText(org.pepsoft.worldpainter.WPI18n.s("wp.eraser.1432aab1d0"));
        toggleButtonEraser.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.click.to.erase.to.9ef8d5ef50"));
        ...
        rendererPreviewer1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.preview.of.pattern.e94e150606"));
        ...
        buttonClear.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.clear.entire.canvas.529bbefeab"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.left.click.to.paint.d1b521aa1b"));
        ...
        labelOpacity.setText(org.pepsoft.worldpainter.WPI18n.s("wp.opacity.bad6a5dd8c"));

        buttonGroupType.add(radioButtonSolidColour);
        radioButtonSolidColour.setSelected(true);
        radioButtonSolidColour.setText(org.pepsoft.worldpainter.WPI18n.s("wp.solid.colour.d8e52736fc"));
        ...
        radioButtonPattern.setText(org.pepsoft.worldpainter.WPI18n.s("wp.pattern.86731c0058"));
    ...
    private void buttonSolidColourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSolidColourActionPerformed
        final Color selectedColour = JColorChooser.showDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.chooseColour"), paintColour);
    ...
    private void toggleButtonEraserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toggleButtonEraserActionPerformed
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.click.to.erase.to.9ef8d5ef50"));
