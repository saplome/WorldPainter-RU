...
public class BiomesPanel extends JPanel implements CustomBiomeManager.CustomBiomeListener {
    ...
    private void initComponents() {
        ...
        addCustomBiomeButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.add.a.custom.biome.a985ad6ec0"));
        addCustomBiomeButton.addActionListener(e -> {
            ...
            if (id == -1) {
                JOptionPane.showMessageDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.h.2419fba987"), org.pepsoft.worldpainter.WPI18n.s("ui.h.db6469c843"), JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private void addButton(CustomBiome customBiome) {
        ...
        button.setMargin(App.BUTTON_INSETS);
        button.setToolTipText(customBiome.getName() + " (" + biome + org.pepsoft.worldpainter.WPI18n.s("ui.h.16991c4488"));
        button.addMouseListener(new MouseAdapter() {
                ...
                private void showPopupMenu(MouseEvent e) {
                    ...
                    item.addActionListener(actionEvent -> {
                        if (JOptionPane.showConfirmDialog(button, org.pepsoft.worldpainter.WPI18n.s("ui.h.e744e05b30") + customBiome.getName() + "\" (ID: " + customBiome.getId() + org.pepsoft.worldpainter.WPI18n.s("ui.h.5be3e13039"), org.pepsoft.worldpainter.WPI18n.s("ui.h.3e78a64dd6"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    static class BiomesSet {
        BiomesSet(int[] biomeOrder, Set<BiomeDescriptor> descriptors, String[] displayNames) {
            ...
            for (int i = 0; i < displayNames.length; i++) {
                this.displayNames[i] = org.pepsoft.worldpainter.WPI18n.biome(displayNames[i]);
            }
        }
