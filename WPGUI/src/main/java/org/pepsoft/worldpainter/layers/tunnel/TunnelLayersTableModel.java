...
public class TunnelLayersTableModel implements TableModel {
    ...
    public String getColumnName(int index) {
        return org.pepsoft.worldpainter.WPI18n.s(COLUMN_NAME_KEYS[index]);
    }
    ...
    private static final String[] COLUMN_NAME_KEYS = {"ui.col.layer", "ui.col.baseIntensityPercent", "ui.col.variationPercentPoints", "ui.col.minimumLevel", "ui.col.maximumLevel"};
