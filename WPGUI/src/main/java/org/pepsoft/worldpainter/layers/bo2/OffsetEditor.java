...
public class OffsetEditor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.edit_offset"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.x.axis.west.to.b9298d4995"));

        spinnerX.setModel(new javax.swing.SpinnerNumberModel(0, -999, 999, 1));
        spinnerX.addChangeListener(this::spinnerXStateChanged);

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.z.axis.north.to.d3fa1e9092"));

        spinnerY.setModel(new javax.swing.SpinnerNumberModel(0, -999, 999, 1));
        spinnerY.addChangeListener(this::spinnerYStateChanged);

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.y.axis.vertical.cb5b47fbe9"));
        ...
        jTextArea1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.the.dotted.square.indicates.31c895ba04"));
