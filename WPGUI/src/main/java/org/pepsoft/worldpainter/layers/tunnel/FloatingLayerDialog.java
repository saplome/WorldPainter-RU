...
public class FloatingLayerDialog extends TunnelLayerDialog {
    public FloatingLayerDialog(Window parent, Platform platform, TunnelLayer layer, Dimension dimension, boolean extendedBlockIds, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, int minHeight, int maxHeight, int baseHeight, int waterLevel) {
        ...
        try {
            ...
            comboBoxBiome1.setRenderer(new BiomeListCellRenderer(colourScheme, null, org.pepsoft.worldpainter.WPI18n.s("ui.option.automatic"), platform));
...
//        });
        ...
        if (layer.getFloorDimensionId() == null) {
            ...
            if (! config.isMessageDisplayedCountAtLeast(PAINT_FLOATING_LAYER_KEY, 3)) {
                doLaterOnEventThread(() -> JOptionPane.showMessageDialog(App.getInstance(),
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.834f42fc06") +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.81b5bbfabc") + layer.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.0721541397") + layer.getPalette() + org.pepsoft.worldpainter.WPI18n.s("ui.h.e128515181") +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.0d3e38ac36")));
    ...
    private void loadSettings() {
        ...
        try {
            ...
            if (layer.getFloorDimensionId() == null) {
                ...
                jPanel1.remove(labelEditDimensionProperties);
            } else {
                jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.to.change.the.f3d60957fc"));
                ...
                jPanel1.remove(checkBoxBeaches);
            }
            ...
            if (platform.capabilities.contains(BIOMES_3D) || platform.capabilities.contains(NAMED_BIOMES)) {
                checkBoxApplyBiomesSurface.setSelected(layer.isApplyBiomesAboveGround());
                checkBoxApplyBiomesSubsurface.setSelected(layer.isApplyBiomesBelowGround());
                spinnerBiomeHeight.setValue(layer.getBiomeHeightAboveGround());
            } else {
                checkBoxApplyBiomesSurface.setEnabled(false);
                checkBoxApplyBiomesSubsurface.setEnabled(false);
            }
        } finally {
            programmaticChange = false;
        }
    ...
    private void saveSettingsTo(TunnelLayer layer, boolean registerMaterials) {
        ...
        layer.setBiomeHeightAboveGround((Integer) spinnerBiomeHeight.getValue());
    }
    ...
    protected void setControlStates() {
        ...
        spinnerBiomeHeight.setEnabled(checkBoxApplyBiomesSurface.isSelected());
    }
    ...
    private Dimension createFloorDimension() {
        ...
        final long seed = dimension.getSeed() + 1 + id;
    ...
    private void editFloorDimensionProperties() {
        final Dimension floorDimension = dimension.getWorld().getDimension(new Anchor(dimension.getAnchor().dim, FLOATING_FLOOR, dimension.getAnchor().invert, layer.getFloorDimensionId()));
        final DimensionPropertiesDialog dialog = new DimensionPropertiesDialog(this, floorDimension, App.getInstance().getColourScheme(), customBiomeManager);
    ...
    private void initComponents() {
        ...
        spinnerBiomeHeight = new javax.swing.JSpinner();
        jLabel30 = new javax.swing.JLabel();
        labelEditDimensionProperties = new javax.swing.JLabel();
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.alpha_configure_floating_dimension"));
        ...
        buttonReset.setText(org.pepsoft.worldpainter.WPI18n.s("wp.reset.526d688f37"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.a.floating.dimension.6de6a19a04"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.name.4e140ba723"));

        textFieldName.setColumns(20);
        textFieldName.setText("jTextField1");

        jLabel11.setText(org.pepsoft.worldpainter.WPI18n.s("wp.paint.4802a5ac60"));
        ...
        jLabel12.setText(org.pepsoft.worldpainter.WPI18n.s("wp.edges.83bec0157d"));

        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.variation.5688482b44"));

        jLabel17.setText(org.pepsoft.worldpainter.WPI18n.s("wp.max.5582e92bd1"));
        ...
        jLabel13.setText(org.pepsoft.worldpainter.WPI18n.s("wp.width.48ccf48dcf"));

        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("wp.level.07ad815187"));

        jLabel16.setText(org.pepsoft.worldpainter.WPI18n.s("wp.absolute.min.fa8a1a4c50"));
        ...
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.bottom.b36a2f68db"));

        buttonGroup3.add(radioButtonBottomFixedLevel);
        radioButtonBottomFixedLevel.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.level.4bf0a268f7"));
        ...
        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("wp.material.d7389bccbb"));
        ...
        radioButtonBottomFixedHeight.setSelected(true);
        radioButtonBottomFixedHeight.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.depth.below.floor.c10052985a"));
        ...
        jLabel25.setText(org.pepsoft.worldpainter.WPI18n.s("wp.biome.64bc244177"));

        jLabel3.setLabelFor(spinnerFloorLevel);
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.level.07ad815187"));

        jLabel27.setLabelFor(spinnerFloodLevel1);
        jLabel27.setText(org.pepsoft.worldpainter.WPI18n.s("wp.relative.water.level.324d5a08be"));
        ...
        checkBoxFloodWithLava1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.lava.instead.of.water.c0ae459a11"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.surface.material.532d489326"));

        jLabel28.setText(org.pepsoft.worldpainter.WPI18n.s("wp.floor.defaults.9f2f5c9ce4"));

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.these.are.the.31151d74af"));

        jLabel18.setText(org.pepsoft.worldpainter.WPI18n.s("wp.shape.b167e56534"));

        buttonGroup4.add(radioButtonSheerEdge);
        radioButtonSheerEdge.setText(org.pepsoft.worldpainter.WPI18n.s("wp.sheer.afa05a6348"));
        ...
        radioButtonLinearEdge.setText(org.pepsoft.worldpainter.WPI18n.s("wp.linear.9a932b3cb3"));
        ...
        radioButtonSmoothEdge.setText(org.pepsoft.worldpainter.WPI18n.s("wp.smooth.a7887cc809"));
        ...
        radioButtonRoundedEdge.setSelected(true);
        radioButtonRoundedEdge.setText(org.pepsoft.worldpainter.WPI18n.s("wp.rounded.990fcd0ba3"));
        ...
        jLabel21.setText(org.pepsoft.worldpainter.WPI18n.s("wp.hill.height.3e91a3270a"));
        ...
        jLabel22.setText(org.pepsoft.worldpainter.WPI18n.s("wp.horizontal.hill.size.4f02a032bb"));
        ...
        checkBoxApplyBiomesSurface.setText(org.pepsoft.worldpainter.WPI18n.s("wp.apply.above.ground.biomes.7d24adcb11"));
        checkBoxApplyBiomesSurface.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkBoxApplyBiomesSurfaceActionPerformed(evt);
            }
        });

        checkBoxApplyBiomesSubsurface.setText(org.pepsoft.worldpainter.WPI18n.s("wp.apply.underground.biomes.675015d62d"));

        checkBoxBeaches.setSelected(true);
        checkBoxBeaches.setText(org.pepsoft.worldpainter.WPI18n.s("wp.beaches.a51789cf50"));
        checkBoxBeaches.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);

        jLabel29.setText(org.pepsoft.worldpainter.WPI18n.s("wp.biomes.600db7b98c"));

        spinnerBiomeHeight.setModel(new javax.swing.SpinnerNumberModel(1, 1, 384, 1));
        spinnerBiomeHeight.setEnabled(false);

        jLabel30.setText(org.pepsoft.worldpainter.WPI18n.s("wp.height.e933dc24fb"));

        labelEditDimensionProperties.setForeground(new java.awt.Color(0, 0, 255));
        labelEditDimensionProperties.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.u.edit.floor.7a13cf0756"));
        ...
        labelEditDimensionProperties.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                labelEditDimensionPropertiesMouseClicked(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(labelEditDimensionProperties, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(spinnerBiomeHeight, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel24.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.you.can.add.1dc55f1920"));
        ...
        buttonNewRoofLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.new.49e5878c7a"));
        ...
        buttonAddRoofLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.copy.existing.862b6382a8"));
        ...
        buttonEditRoofLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.edit.7dce122004"));
        ...
        buttonRemoveRoofLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.1063e38cb5"));
        ...
        jLabel23.setText(org.pepsoft.worldpainter.WPI18n.s("wp.alpha.002101f872"));

        jLabel26.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.this.is.an.17fd04792d"));
    ...
    private void checkBoxApplyBiomesSurfaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxApplyBiomesSurfaceActionPerformed
        setControlStates();
    }//GEN-LAST:event_checkBoxApplyBiomesSurfaceActionPerformed

    private void labelEditDimensionPropertiesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelEditDimensionPropertiesMouseClicked
        editFloorDimensionProperties();
    }//GEN-LAST:event_labelEditDimensionPropertiesMouseClicked
    ...
    private javax.swing.JLabel labelEditDimensionProperties;
    ...
    private javax.swing.JSpinner spinnerBiomeHeight;
