...
public class TunnelLayerDialog extends AbstractEditLayerDialog<TunnelLayer> implements ChangeListener, ListSelectionListener {
    ...
    protected TunnelLayerDialog(Window parent, Platform platform, TunnelLayer layer, Dimension dimension, boolean extendedBlockIds, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, int minHeight, int maxHeight, int baseHeight, int waterLevel, boolean init) {
        ...
        try {
            ...
            comboBoxBiome.setRenderer(new BiomeListCellRenderer(colourScheme, customBiomeManager, org.pepsoft.worldpainter.WPI18n.s("ui.option.none"), platform));
...
//        });
    ...
    protected void ok() {
        ...
        if ((! radioButtonFloorCustomDimension.isSelected()) && (layer.getFloorDimensionId() != null)) {
            DesktopUtils.beep();
            if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.f9c2708a4b"), org.pepsoft.worldpainter.WPI18n.s("ui.h.0a2fa4a8d3"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION) {
                return;
            }
            ...
            if (floorDimension != null) {
                ...
                if (! config.isMessageDisplayedCountAtLeast(PAINT_TUNNEL_LAYER_KEY, 3)) {
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(App.getInstance(),
                            org.pepsoft.worldpainter.WPI18n.s("ui.h.c323829877") +
                            ...
                            org.pepsoft.worldpainter.WPI18n.s("ui.h.aab83e2aa0")));
...
//        } else {
//            labelTunnelHeight.setText(org.pepsoft.worldpainter.WPI18n.s("wp.tunnel.height.variable.926c4790d0"));
//        }
        generatePreview();
    }
        ...
        if (customLayers.size() > 15) {
            ...
            app.getCustomLayersByPalette().entrySet().stream()
                .map((entry) -> {
                    ...
                    JMenu paletteMenu = new JMenu(palette != null ? palette : org.pepsoft.worldpainter.WPI18n.s("ui.h.eb110387c8"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.configure_cave_tunnel_layer"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.underground.tunnels.and.28931b68e0"));
        ...
        radioButtonFloorFixedLevel.setSelected(true);
        radioButtonFloorFixedLevel.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.level.4bf0a268f7"));
        ...
        jLabel12.setText(org.pepsoft.worldpainter.WPI18n.s("wp.walls.401599e5d5"));

        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.variation.5688482b44"));
        ...
        jLabel20.setText(org.pepsoft.worldpainter.WPI18n.s("wp.options.ebcc39462e"));

        buttonGroup3.add(radioButtonRoofFixedDepth);
        radioButtonRoofFixedDepth.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.depth.2c96553055"));
        ...
        jLabel18.setText(org.pepsoft.worldpainter.WPI18n.s("wp.absolute.min.fa8a1a4c50"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.floor.15da56bb9c"));
        ...
        radioButtonFloorFixedDepth.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.depth.2c96553055"));
        ...
        jLabel14.setText(org.pepsoft.worldpainter.WPI18n.s("wp.material.d7389bccbb"));

        checkBoxFloodWithLava.setText(org.pepsoft.worldpainter.WPI18n.s("wp.flood.with.lava.e22484dd38"));
        ...
        jLabel13.setText(org.pepsoft.worldpainter.WPI18n.s("wp.bottom.width.bd9c639ce1"));
        ...
        checkBoxRemoveWater.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.water.or.lava.8913568186"));
        ...
        jLabel19.setText(org.pepsoft.worldpainter.WPI18n.s("wp.max.5582e92bd1"));

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.material.d7389bccbb"));

        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.ceiling.b23ca53084"));

        buttonGroup1.add(radioButtonFloorInverse);
        radioButtonFloorInverse.setText(org.pepsoft.worldpainter.WPI18n.s("wp.opposite.of.terrain.ab4f7e14fc"));
        ...
        checkBoxFlood.setText(org.pepsoft.worldpainter.WPI18n.s("wp.flood.the.caves.tunnels.1444658a1a"));
        ...
        radioButtonRoofFixedLevel.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.level.4bf0a268f7"));
        ...
        radioButtonRoofInverse.setText(org.pepsoft.worldpainter.WPI18n.s("wp.opposite.of.terrain.ab4f7e14fc"));
        ...
        jLabel15.setText(org.pepsoft.worldpainter.WPI18n.s("wp.top.width.99d0850dbf"));
        ...
        jLabel21.setText(org.pepsoft.worldpainter.WPI18n.s("wp.level.07ad815187"));

        jLabel23.setText(org.pepsoft.worldpainter.WPI18n.s("wp.biome.64bc244177"));

        buttonGroup1.add(radioButtonFloorCustomDimension);
        radioButtonFloorCustomDimension.setText(org.pepsoft.worldpainter.WPI18n.s("wp.custom.dimension.7226c0c6ac"));
        ...
        radioButtonRoofFixedHeight.setSelected(true);
        radioButtonRoofFixedHeight.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fixed.height.above.floor.bbb5a14ff1"));
        ...
        jLabel26.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fill.with.5376c930c9"));

        buttonGroup2.add(radioButtonFillWithAir);
        radioButtonFillWithAir.setText(org.pepsoft.worldpainter.WPI18n.s("wp.air.3c45881163"));
        ...
        radioButtonFillWithLight.setText(org.pepsoft.worldpainter.WPI18n.s("wp.light.7e39fe807b"));
        ...
        radioButtonFillWithCustom.setText(org.pepsoft.worldpainter.WPI18n.s("wp.custom.cc52d3ae8b"));
        ...
        radioButtonFillWithCaveAir.setSelected(true);
        radioButtonFillWithCaveAir.setText(org.pepsoft.worldpainter.WPI18n.s("wp.cave.air.7de45da5a0"));
        ...
        jLabel22.setText(org.pepsoft.worldpainter.WPI18n.s("wp.you.can.add.custom.f1a4e7b1e2"));
        ...
        buttonNewFloorLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.new.49e5878c7a"));
        ...
        buttonAddFloorLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.copy.existing.862b6382a8"));
        ...
        buttonEditFloorLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.edit.7dce122004"));
        ...
        buttonRemoveFloorLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.1063e38cb5"));
        ...
        jLabel24.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.you.can.add.1578a6fc14"));
