...
public class PlantLayerEditor extends AbstractLayerEditor<PlantLayer> {
    ...
    public void reset() {
        ...
        for (int i = 0; i < ALL_PLANTS.length; i++) {
            ...
            if (! isCompatibleWithPlatform(ALL_PLANTS[i], platform)) {
                ...
                plantLabels[i].setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.thisPlantIsNot"));
    ...
    private void addPlantRow(final JPanel panel, final Plant plant, final int index, final boolean enabled) {
        ...
        if (! enabled) {
            ...
            spinners[index].setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.thisPlantIsNot"));
        }
    ...
    private void initComponents() {
        ...
        checkBoxGenerateTilledDirt.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.turnGrassAndDirt"));
        checkBoxGenerateTilledDirt.setEnabled(false);

        fieldName.setColumns(20);
        fieldName.setText("jTextField1");

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.paint"));

        checkBoxOnlyValidBlocks.setSelected(true);
        checkBoxOnlyValidBlocks.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.onlyPlaceOnValid"));
