...
public class AddLayerDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.addLayer.title"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.selectTheLayerTo"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.layer"));

        comboBoxLayer.setModel(new DefaultComboBoxModel(allLayers.toArray()));
        comboBoxLayer.setRenderer(new LayerListCellRenderer());

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.factor"));

        spinnerFactor.setModel(new javax.swing.SpinnerNumberModel(100, 1, 1500, 1));

        jLabel4.setText("%");

        checkBoxHide.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.hideFromPanel"));
