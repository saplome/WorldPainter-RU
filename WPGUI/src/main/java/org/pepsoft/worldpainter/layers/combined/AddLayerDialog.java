...
public class AddLayerDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.add_layer"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.layer.to.232f3861d1"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.layer.44ecdf0f12"));

        comboBoxLayer.setModel(new DefaultComboBoxModel(allLayers.toArray()));
        comboBoxLayer.setRenderer(new LayerListCellRenderer());

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.factor.efce75a5f0"));

        spinnerFactor.setModel(new javax.swing.SpinnerNumberModel(100, 1, 1500, 1));

        jLabel4.setText("%");

        checkBoxHide.setText(org.pepsoft.worldpainter.WPI18n.s("wp.hide.from.panel.fdb646884a"));
