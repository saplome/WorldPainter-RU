...
//            Layer layer = Caverns.INSTANCE;
    ...
    public static abstract class Pattern {
        ...
        public String getDescription() {
            final String key = "layerPreview.pattern." + description.replaceAll("[^A-Za-z0-9]+", "_").replaceAll("^_|_$", "");
            final String value = WPI18n.s(key);
            return value.equals(key) ? description : value;
        }
