...
public class AboutDialog extends javax.swing.JDialog implements WindowListener {
    ...
    public AboutDialog(Window parent, World2 world, WorldPainter view, UndoManager undoManager) {
        ...
        JTextPane languagesTextPane = new JTextPane();
        languagesTextPane.setContentType("text/html");
        languagesTextPane.setEditable(false);
        languagesTextPane.setText(loadLanguagesInfo());
        languagesTextPane.addHyperlinkListener(this::jTextPane1HyperlinkUpdate);
        languagesTextPane.setCaretPosition(0);
        jTabbedPane1.insertTab(WPI18n.s("ui.about.languagesTab"), null, new JScrollPane(languagesTextPane), null, 0);
    ...
    private String loadLanguagesInfo() {
        final Font defaultTextPaneFont = jTextPane2.getFont();
        final Color textColour = jTextPane2.getForeground();
        final Color linkColour = ((textColour.getRed() + textColour.getGreen() + textColour.getBlue()) > 384) ? Color.CYAN : Color.BLUE;
    ...
    private String loadTechInfo(World2 world, WorldPainter view, UndoManager undoManager) {
        ...
        if (Configuration.getInstance().isSafeMode()) {
            message.append(org.pepsoft.worldpainter.WPI18n.s("about.safeMode")).append('\n');
        }
...
//        }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.about.title"));
        setResizable(false);
        ...
        jTextPane1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.html.htmlHeadHeadBody"));
        jTextPane1.addHyperlinkListener(this::jTextPane1HyperlinkUpdate);
        jScrollPane1.setViewportView(jTextPane1);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.about.credits"), jScrollPane1);

        jScrollPane2.setBorder(null);

        jTextPane2.setEditable(false);
        jTextPane2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.eenPaarRegelsOm"));
        jScrollPane2.setViewportView(jTextPane2);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.about.changeLog"), jScrollPane2);

        jScrollPane3.setBorder(null);

        jTextPane3.setEditable(false);
        jTextPane3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.eenPaarRegelsOm"));
        jScrollPane3.setViewportView(jTextPane3);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.about.techInfo"), jScrollPane3);
