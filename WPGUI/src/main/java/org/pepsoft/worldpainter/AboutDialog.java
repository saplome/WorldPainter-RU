...
//        }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.about_worldpainter"));
        setResizable(false);
        ...
        jTextPane1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.head.head.body.3ba1e17d8b"));
        jTextPane1.addHyperlinkListener(this::jTextPane1HyperlinkUpdate);
        jScrollPane1.setViewportView(jTextPane1);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.948a2e3548"), jScrollPane1);

        jScrollPane2.setBorder(null);

        jTextPane2.setEditable(false);
        jTextPane2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.een.paar.regels.om.55ee0f526a"));
        jScrollPane2.setViewportView(jTextPane2);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.64a3927357"), jScrollPane2);

        jScrollPane3.setBorder(null);

        jTextPane3.setEditable(false);
        jTextPane3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.een.paar.regels.om.55ee0f526a"));
        jScrollPane3.setViewportView(jTextPane3);

        jTabbedPane1.addTab(org.pepsoft.worldpainter.WPI18n.s("ui.fe48977203"), jScrollPane3);
