...
class MapSelectionController {
    ...
    void selectPaintOnMap(Set<PaintType> paintTypes, SelectionListener paintSelectionListener) {
        ...
        final JLabel label = new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.help.clickMapToSelectPrefix") + paintTypeDescription + org.pepsoft.worldpainter.WPI18n.s("ui.help.pressEscToCancelSuffix"));
