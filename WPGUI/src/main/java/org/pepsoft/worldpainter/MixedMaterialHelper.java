...
public class MixedMaterialHelper {
    ...
    public static void save(Component parent, MixedMaterial material) {
        ...
        if (selectedFile != null) {
            ...
            if (selectedFile.isFile() && (JOptionPane.showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.h.0b8c2d31e3") + selectedFile.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.859e1b0d68"), org.pepsoft.worldpainter.WPI18n.s("ui.h.b06d9a520d"), JOptionPane.YES_NO_OPTION) == JOptionPane.NO_OPTION)) {
                return;
            }
            try {
