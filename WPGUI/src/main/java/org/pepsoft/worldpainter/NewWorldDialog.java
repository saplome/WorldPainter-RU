...
public class NewWorldDialog extends WorldPainterDialog {
    ...
    public NewWorldDialog(App app, ColourScheme colourScheme, String name, long seed, Platform platform, Anchor anchor, int defaultMinHeight, int defaultMaxHeight, Dimension baseDimension, Set<Point> tiles) {
        ...
        if (! anchor.equals(NORMAL_DETAIL)) {
            setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.p.add") + org.pepsoft.worldpainter.WPI18n.dimensionName(anchor));
        }
...
//        availableMemory -= 250000000L;
        ...
        if (totalEstimatedDataSize > availableMemory) {
            return JOptionPane.showConfirmDialog(parent, org.pepsoft.worldpainter.WPI18n.s("ui.h.9198ecda9d"), org.pepsoft.worldpainter.WPI18n.s("ui.h.8e7516b25f"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) == JOptionPane.YES_OPTION;
        }
        return true;
    }
...
//                                            System.out.println("Progress: " + tileCount[0] + " of " + approximateTotalTiles + " (" + ((float) tileCount[0] / approximateTotalTiles) + ")");
    ...
    private void updateWalkingTimes() {
        ...
        if (checkBoxCircular.isSelected()) {
            ...
            if (westEastTime.equals(northSouthTime)) {
                ...
                labelWalkingTimes.setText(org.pepsoft.worldpainter.WPI18n.s("ui.71310fb090") + westEastTime + org.pepsoft.worldpainter.WPI18n.s("ui.h.297d9b178e") + northSouthTime);
            }
        }
        if (scale == 1.0f) {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.create_new_world"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.level.07ad815187"));
        ...
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.surface.material.532d489326"));

        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.water.level.3cd4b936aa"));
        ...
        checkBoxCircular.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.this.will.create.7a9df2c75d"));
        ...
        jLabel19.setText(org.pepsoft.worldpainter.WPI18n.s("wp.horizontal.hill.size.4f02a032bb"));
        ...
        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("wp.name.4e140ba723"));

        jLabel11.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.e734964953"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.x.9dd4e46126"));
        ...
        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.minecraft.seed.d724af618f"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.in.multiples.of.3df432fa6a"));
        ...
        buttonRandomSeed.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.choose.a.random.seed.9e41c9f983"));
        ...
        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("wp.upper.c9aee88397"));

        jLabel17.setText(org.pepsoft.worldpainter.WPI18n.s("wp.minecraft.default.b237d20e41"));

        fieldName.setText(org.pepsoft.worldpainter.WPI18n.s("wp.generated.world.a8e95f5ad2"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.dimensions.adcb4df47a"));

        checkBoxLava.setText(org.pepsoft.worldpainter.WPI18n.s("wp.lava.instead.of.water.c0ae459a11"));
        ...
        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.topography.37d50294d9"));

        jLabel18.setText(org.pepsoft.worldpainter.WPI18n.s("wp.hill.height.3e91a3270a"));
        ...
        radioButtonOceanSeed.setText(org.pepsoft.worldpainter.WPI18n.s("wp.ocean.f41054884f"));
        radioButtonOceanSeed.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.a.seed.with.a.fdd5df2cfa"));
        ...
        radioButtonLandSeed.setText(org.pepsoft.worldpainter.WPI18n.s("wp.land.512ef7c688"));
        radioButtonLandSeed.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.a.seed.with.a.64211a3c6a"));
        ...
        radioButtonCustomSeed.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.set.your.own.custom.a5bb02a477"));
        ...
        checkBoxExtendedBlockIds.setText(org.pepsoft.worldpainter.WPI18n.s("wp.extended.block.ids.cd0cb96d4e"));
        checkBoxExtendedBlockIds.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.wether.to.support.block.a1841dcc52"));
        checkBoxExtendedBlockIds.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);

        jLabel12.setText(org.pepsoft.worldpainter.WPI18n.s("wp.edge.to.edge.walking.b00096991c"));

        labelWalkingTimes.setText("...");

        buttonGroup3.add(radioButtonSimpleTerrain);
        radioButtonSimpleTerrain.setSelected(true);
        radioButtonSimpleTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.simple.cfd31a867e"));
        ...
        radioButtonAdvancedTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.advanced.c6a2467130"));
        ...
        labelAdvancedTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.u.configure.default.7685eb7f4a"));
        ...
        labelScaledDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scaled.x.9e6bebbc6d"));

        jLabel15.setText(org.pepsoft.worldpainter.WPI18n.s("wp.build.limits.eb45fe45e2"));
        ...
        jLabel16.setText(org.pepsoft.worldpainter.WPI18n.s("wp.lower.d9f71c5d70"));
        ...
        buttonCreate.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.686e697538"));
    ...
    private void checkBoxCircularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBoxCircularActionPerformed
        if (checkBoxCircular.isSelected()) {
            ...
            jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.even.number.9421968635"));
        } else {
