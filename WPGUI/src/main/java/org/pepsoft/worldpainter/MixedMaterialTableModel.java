...
public final class MixedMaterialTableModel implements TableModel, Cloneable {
    ...
    public int getColumnCount() {
        return (mode == Mode.BLOBS) ? COLUMN_NAME_KEYS.length : (COLUMN_NAME_KEYS.length - 1);
    }
    ...
    private static final String[] COLUMN_NAME_KEYS = {"ui.col.material", "ui.col.count", "ui.col.scalePercent"};
