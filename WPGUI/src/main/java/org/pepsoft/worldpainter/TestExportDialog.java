...
public class TestExportDialog extends WorldPainterDialog {
    ...
    public TestExportDialog(Window parent, World2 world, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, Set<Layer> hiddenLayers, boolean contourLines, int contourSeparation, LightOrigin lightOrigin) {
        ...
        comboBoxDimension.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                switch ((int) value) {
                    case DIM_NORMAL:
                        setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.surface"));
                        break;
                    case DIM_NETHER:
                        setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.nether"));
                        break;
                    case DIM_END:
                        setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.end"));
                        break;
                }
                return this;
            }
        ...
        if ((selectedTiles != null) && (! selectedTiles.isEmpty())) {
            checkBoxTiles.setText(org.pepsoft.worldpainter.WPI18n.s("ui.2c4e1f122f") + selectedTiles.size() + org.pepsoft.worldpainter.WPI18n.s("ui.h.d9a023307b"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.test_export"));

        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.cancel.ea4788705e"));
        ...
        jButton3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.export.0095a9fa74"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.perform.a.test.0903502671"));

        checkBoxTiles.setText(org.pepsoft.worldpainter.WPI18n.s("wp.export.subset.of.tiles.aa938c3b43"));
        ...
        checkBoxUnderground.setText(org.pepsoft.worldpainter.WPI18n.s("wp.do.not.export.underground.5526662108"));
        ...
        checkBoxCaves.setText(org.pepsoft.worldpainter.WPI18n.s("wp.do.not.export.caves.0238b1c83b"));
        checkBoxCaves.setEnabled(false);

        checkBoxResources.setSelected(true);
        checkBoxResources.setText(org.pepsoft.worldpainter.WPI18n.s("wp.do.not.export.resources.74aff9c679"));
        checkBoxResources.setEnabled(false);

        checkBoxLighting.setSelected(true);
        checkBoxLighting.setText(org.pepsoft.worldpainter.WPI18n.s("wp.do.not.perform.lighting.a63453c706"));

        checkBoxLeaves.setSelected(true);
        checkBoxLeaves.setText(org.pepsoft.worldpainter.WPI18n.s("wp.do.not.perform.leaf.a6ebf2c971"));

        checkBoxDimension.setSelected(true);
        checkBoxDimension.setText(org.pepsoft.worldpainter.WPI18n.s("wp.export.only.the.bc0021ff24"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.dimension.c4cf4802b3"));
