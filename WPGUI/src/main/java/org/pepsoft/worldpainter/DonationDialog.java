...
public final class DonationDialog extends WorldPainterDialog {
    ...
    private void donate() {
        try {
            ...
            showInfo(this, WPI18n.s("the.donation.paypal.page.has.been.opened"), WPI18n.s("thank.you"));
    ...
    private void alreadyDonated() {
        config.setDonationStatus(Configuration.DonationStatus.DONATED);
        config.setShowDonationDialogAfter(config.getLaunchCount() + 100);
        showInfo(this, WPI18n.s("ui.dialog.support.alreadyDonated.message"), WPI18n.s("thank.you"));
    ...
    private void noThanks() {
        ...
        showInfo(this, WPI18n.s("ui.dialog.support.noThanks.message"), WPI18n.s("ui.dialog.support.noThanks.title"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.support.title"));
        setResizable(false);
        ...
        jTextArea1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.message.thankYouForUsing"));
        ...
        buttonAlreadyDonated.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.iHaveAlreadyDonated"));
        ...
        buttonAskLater.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.askMeLater"));
        ...
        buttonNoThanks.setText(org.pepsoft.worldpainter.WPI18n.s("ui.button.noThankYou"));
