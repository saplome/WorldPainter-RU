        ...
        if ((file != null) && file.isFile()) {
            if (file.canRead()) {
                ...
                try {
                    ...
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.49e34f228e"), org.pepsoft.worldpainter.WPI18n.s("ui.h.84b07a6b5f"), JOptionPane.ERROR_MESSAGE));
                    overlay.setEnabled(false);
                    return;
                } catch (RuntimeException | Error e) {
                    logger.error(e.getClass().getSimpleName() + " while loading image " + file ,e);
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.fd5bfb10d0"), org.pepsoft.worldpainter.WPI18n.s("ui.h.84b07a6b5f"), JOptionPane.ERROR_MESSAGE));
                    overlay.setEnabled(false);
                    return;
                }
                if (overlayImage != null) {
                    ...
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.ba7775927d") + file, org.pepsoft.worldpainter.WPI18n.s("ui.h.84b07a6b5f"), JOptionPane.ERROR_MESSAGE));
                }
                if (overlayImage != null) {
                ...
                doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.80bbda274c") + file, org.pepsoft.worldpainter.WPI18n.s("ui.h.7ac9a0dc3c"), JOptionPane.ERROR_MESSAGE));
                overlay.setEnabled(false);
            }
        } else {
            doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.bccad191b2") + file, org.pepsoft.worldpainter.WPI18n.s("ui.h.7ac9a0dc3c"), JOptionPane.ERROR_MESSAGE));
            overlay.setEnabled(false);
        }
    }
    ...
    private BufferedImage scaleImage(BufferedImage image, GraphicsConfiguration graphicsConfiguration, float scale) {
        try {
            ...
            doLaterOnEventThread(() -> JOptionPane.showMessageDialog(null,
                    org.pepsoft.worldpainter.WPI18n.s("ui.h.d9c8575547") + ((scale == 100) ? org.pepsoft.worldpainter.WPI18n.s("image.operation.optimising") : org.pepsoft.worldpainter.WPI18n.s("image.operation.scaling")) + org.pepsoft.worldpainter.WPI18n.s("ui.h.0fb0c1ac75"),
                    org.pepsoft.worldpainter.WPI18n.s("ui.h.a8c87e841e") + ((scale == 100) ? org.pepsoft.worldpainter.WPI18n.s("image.operation.optimising.title") : org.pepsoft.worldpainter.WPI18n.s("image.operation.scaling.title")) + org.pepsoft.worldpainter.WPI18n.s("ui.h.27648cd682"),
