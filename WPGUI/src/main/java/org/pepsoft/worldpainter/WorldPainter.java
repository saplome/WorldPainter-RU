...
//                }
        ...
        if ((file != null) && file.isFile()) {
            if (file.canRead()) {
                ...
                try {
                    ...
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayLoadErrorInvalid"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorLoadingImage.title"), JOptionPane.ERROR_MESSAGE));
                    overlay.setEnabled(false);
                    return;
                } catch (RuntimeException | Error e) {
                    logger.error(e.getClass().getSimpleName() + " while loading image " + file ,e);
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayLoadErrorMemory"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorLoadingImage.title"), JOptionPane.ERROR_MESSAGE));
                    overlay.setEnabled(false);
                    return;
                }
                if (overlayImage != null) {
                    ...
                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayNotRecognisableImage") + file, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorLoadingImage.title"), JOptionPane.ERROR_MESSAGE));
                }
                if (overlayImage != null) {
                ...
                doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayAccessDenied") + file, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorEnablingOverlay.title"), JOptionPane.ERROR_MESSAGE));
                overlay.setEnabled(false);
            }
        } else {
            doLaterOnEventThread(() -> JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayFileNotFound") + file, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorEnablingOverlay.title"), JOptionPane.ERROR_MESSAGE));
            overlay.setEnabled(false);
        }
    }
    ...
    private BufferedImage scaleImage(BufferedImage image, GraphicsConfiguration graphicsConfiguration, float scale) {
        try {
            ...
            doLaterOnEventThread(() -> JOptionPane.showMessageDialog(null,
                    org.pepsoft.worldpainter.WPI18n.s("ui.message.errorOccurredWhile") + ((scale == 100) ? org.pepsoft.worldpainter.WPI18n.s("image.operation.optimising") : org.pepsoft.worldpainter.WPI18n.s("image.operation.scaling")) + org.pepsoft.worldpainter.WPI18n.s("ui.message.overlayLoadMemorySuffix"),
                    org.pepsoft.worldpainter.WPI18n.s("ui.dialog.errorPrefix") + ((scale == 100) ? org.pepsoft.worldpainter.WPI18n.s("image.operation.optimising.title") : org.pepsoft.worldpainter.WPI18n.s("image.operation.scaling.title")) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.imageSuffix"),
