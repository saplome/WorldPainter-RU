...
public class MergeWorldDialog extends WorldPainterDialog {
    ...
    public MergeWorldDialog(Window parent, World2 world, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, Set<Layer> hiddenLayers, boolean contourLines, int contourSeparation, TileRenderer.LightOrigin lightOrigin, WorldPainter view) {
        ...
        if (selectedTiles != null) {
            radioButtonExportSelection.setText(org.pepsoft.worldpainter.WPI18n.s("ui.d443733e33") + selectedTiles.size() + org.pepsoft.worldpainter.WPI18n.s("ui.h.ea48844c00"));
    ...
    private void merge() {
        ...
        if (showWarning && (JOptionPane.showConfirmDialog(this, sb.toString(), org.pepsoft.worldpainter.WPI18n.s("ui.h.667a99bd4d"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) != JOptionPane.YES_OPTION)) {
            return;
        }
    ...
    private void setControlStates() {
        ...
        if (mapDir.isDirectory()) {
            ...
            if (platform != null) {
                ...
                labelPlatform.setText(org.pepsoft.worldpainter.WPI18n.s("wp.no.supported.format.detected.eb9a16251e"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.merging"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.existing.map.f20e960849"));
        ...
        buttonMerge.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.68be4837f6"));
        ...
        radioButtonAll.setSelected(true);
        radioButtonAll.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.old.and.new.837ef62907"));
        radioButtonAll.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.i.will.merge.c2e313e34b"));
        ...
        radioButtonReplaceChunks.setText(org.pepsoft.worldpainter.WPI18n.s("wp.completely.replace.chunks.with.0226843969"));
        radioButtonReplaceChunks.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.i.this.will.c181828a7d"));
        ...
        radioButtonExportEverything.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.all.tiles.e62e115942"));
        ...
        radioButtonExportSelection.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.selected.tiles.5c50660a0d"));
        ...
        labelSelectTiles.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.u.select.tiles.9b2790e355"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.choose.which.part.of.3dc4f37172"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.choose.what.kind.c9badfd2e3"));

        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.options.for.the.existing.5449a2dcd1"));

        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.b.above.b.90348c1755"));

        checkBoxRemoveTrees.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.all.trees.and.99c00fe91d"));
        checkBoxRemoveTrees.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.removes.all.wood.and.a2fbc0361e"));

        checkBoxRemoveVegetation.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.all.other.vegetation.84a04d381d"));
        checkBoxRemoveVegetation.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.removes.all.tall.grass.50c8266f8b"));

        checkBoxRemoveManMadeAboveGround.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.all.man.made.33c19b00f5"));
        checkBoxRemoveManMadeAboveGround.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.removes.any.block.which.e11feaa1f5"));

        checkBoxRemoveResources.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.all.resources.ores.7ea6f7e9d1"));
        checkBoxRemoveResources.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.replaces.all.resource.ore.7701ea4a57"));

        checkBoxFillCaves.setText(org.pepsoft.worldpainter.WPI18n.s("wp.fill.in.all.caves.c09a8d0e68"));
        checkBoxFillCaves.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.replaces.all.air.234367aeb5"));

        checkBoxRemoveManMadeBelowGround.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.all.man.made.33c19b00f5"));
        checkBoxRemoveManMadeBelowGround.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.replaces.any.block.which.3019f12b43"));

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.b.below.b.fecc7cf377"));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/pepsoft/worldpainter/icons/error.png"))); // NOI18N
        jLabel3.setText(" ");
        jLabel3.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.html.this.removes.em.d3acc0b2cb"));

        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("wp.thickness.of.surface.layer.5926770045"));

        spinnerSurfaceThickness.setModel(new javax.swing.SpinnerNumberModel(3, 1, 256, 1));

        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.e734964953"));

        checkBoxSurface.setText(org.pepsoft.worldpainter.WPI18n.s("wp.surface.aa0d528ba1"));
        ...
        checkBoxNether.setText(org.pepsoft.worldpainter.WPI18n.s("wp.nether.9134d6dfbf"));
        ...
        checkBoxEnd.setText(org.pepsoft.worldpainter.WPI18n.s("wp.end.87557f1157"));
        ...
        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("wp.map.format.980a0dbfbe"));

        checkBoxAboveMergeBlocks.setSelected(true);
        checkBoxAboveMergeBlocks.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.blocks.1bc62f6a9b"));

        checkBoxAboveMergeBiomes.setText(org.pepsoft.worldpainter.WPI18n.s("wp.replace.biomes.d9d533ec46"));

        checkBoxBelowMergeBlocks.setText(org.pepsoft.worldpainter.WPI18n.s("wp.merge.blocks.1bc62f6a9b"));

        checkBoxBelowMergeBiomes.setText(org.pepsoft.worldpainter.WPI18n.s("wp.replace.biomes.d9d533ec46"));
