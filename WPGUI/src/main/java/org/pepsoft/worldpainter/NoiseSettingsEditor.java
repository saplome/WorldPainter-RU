...
public class NoiseSettingsEditor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.range.d5bac5e95c"));
        jLabel1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.vertical.height.difference.d8d4946f94"));

        spinnerRange.setModel(new javax.swing.SpinnerNumberModel(0, 0, 256, 1));
        spinnerRange.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.vertical.height.difference.d8d4946f94"));
        spinnerRange.addChangeListener(this::spinnerRangeStateChanged);

        jLabel2.setLabelFor(spinnerScale);
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.c00ef4c184"));
        jLabel2.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.horizontal.scale.lower.fe7a657bdc"));

        spinnerScale.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(100), Integer.valueOf(1), null, Integer.valueOf(1)));
        spinnerScale.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.horizontal.scale.lower.fe7a657bdc"));
        spinnerScale.setEnabled(false);
        spinnerScale.addChangeListener(this::spinnerScaleStateChanged);

        jLabel3.setLabelFor(spinnerOctaves);
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.roughness.0713a7f86c"));
        jLabel3.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.how.random.or.chaotic.f053218949"));

        spinnerOctaves.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        spinnerOctaves.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.how.random.or.chaotic.f053218949"));
