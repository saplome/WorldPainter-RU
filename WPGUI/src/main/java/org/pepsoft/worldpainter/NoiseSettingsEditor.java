...
public class NoiseSettingsEditor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.range"));
        jLabel1.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.theVerticalHeightDifference"));

        spinnerRange.setModel(new javax.swing.SpinnerNumberModel(0, 0, 256, 1));
        spinnerRange.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.theVerticalHeightDifference"));
        spinnerRange.addChangeListener(this::spinnerRangeStateChanged);

        jLabel2.setLabelFor(spinnerScale);
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.scale.scaleF4c184"));
        jLabel2.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.theHorizontalScaleLower"));

        spinnerScale.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(100), Integer.valueOf(1), null, Integer.valueOf(1)));
        spinnerScale.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.theHorizontalScaleLower"));
        spinnerScale.setEnabled(false);
        spinnerScale.addChangeListener(this::spinnerScaleStateChanged);

        jLabel3.setLabelFor(spinnerOctaves);
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.roughness"));
        jLabel3.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.howRandomOrChaotic"));

        spinnerOctaves.setModel(new javax.swing.SpinnerNumberModel(0, 0, 3, 1));
        spinnerOctaves.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.howRandomOrChaotic"));
