...
public class RaiseRotatedPyramid extends MouseOrTabletOperation {
    ...
    private static final StandardOptionsPanel OPTIONS_PANEL = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.raiseRotatedPyramid.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.raiseRotatedPyramid.body"));
}