...
public class RaisePyramid extends MouseOrTabletOperation {
    ...
    private static final StandardOptionsPanel OPTIONS_PANEL = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.raisePyramid.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.raisePyramid.body"));
}