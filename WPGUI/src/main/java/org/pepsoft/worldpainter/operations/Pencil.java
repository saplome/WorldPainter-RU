...
public class Pencil extends AbstractPaintOperation {
    ...
    private final StandardOptionsPanel optionsPanel = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.pencil.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.pencil.body")) {
        @Override
