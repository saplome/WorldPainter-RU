...
public class Flatten extends AbstractBrushOperation {
    ...
    private final TerrainShapingOptionsPanel optionsPanel = new TerrainShapingOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("operation.Flatten.name"),
            org.pepsoft.worldpainter.WPI18n.s("operation.Flatten.help"), options) {
        @Override
