...
public class SetSpawnPoint extends MouseOrTabletOperation {
    ...
    protected void tick(int centreX, int centreY, boolean inverse, boolean first, float dynamicLevel) {
        if (first) {
            ...
            if (spawnHeight == Integer.MIN_VALUE) {
                // No tile
                if (JOptionPane.showConfirmDialog(getView(), org.pepsoft.worldpainter.WPI18n.s("ui.h.efbfb425c7"), org.pepsoft.worldpainter.WPI18n.s("operation.SetSpawnPoint.name"), JOptionPane.YES_NO_CANCEL_OPTION) != JOptionPane.OK_OPTION) {
                    return;
                }
            }
    ...
    private static final JPanel OPTIONS_PANEL = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.h2.4fd1dddbd7"), org.pepsoft.worldpainter.WPI18n.s("ui.h2.f5970c168d"));
}
