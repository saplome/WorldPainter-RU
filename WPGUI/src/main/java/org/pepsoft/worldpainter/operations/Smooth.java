...
public class Smooth extends AbstractBrushOperation {
    ...
    private final TerrainShapingOptionsPanel optionsPanel = new TerrainShapingOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("operation.Smooth.name"),
            org.pepsoft.worldpainter.WPI18n.s("operation.Smooth.help"), options);
