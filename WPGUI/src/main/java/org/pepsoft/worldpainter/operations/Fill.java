...
public class Fill extends MouseOrTabletOperation implements PaintOperation {
    ...
    protected void tick(int centreX, int centreY, boolean inverse, boolean first, float dynamicLevel) {
        ...
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(getView(), org.pepsoft.worldpainter.WPI18n.s("ui.h.c7b347722d"), org.pepsoft.worldpainter.WPI18n.s("ui.h.eb7ca5f641"), JOptionPane.ERROR_MESSAGE);
            } finally {
                synchronized (dimension) {
    ...
    private final JPanel optionsPanel = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.h2.db3e3f51c9"), null) {
        {
