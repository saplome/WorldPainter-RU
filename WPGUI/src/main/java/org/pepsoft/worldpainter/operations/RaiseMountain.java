...
public class RaiseMountain extends AbstractBrushOperation {
    public RaiseMountain(WorldPainter view) {
        ...
        optionsPanel = new TerrainShapingOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("operation.RaiseMountain.panelName"),
                org.pepsoft.worldpainter.WPI18n.s("operation.RaiseMountain.help"), options);
    }
