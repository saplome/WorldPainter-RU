...
public class Height extends AbstractBrushOperation {
    ...
    private final TerrainShapingOptionsPanel optionsPanel = new TerrainShapingOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("operation.Height.name"),
            org.pepsoft.worldpainter.WPI18n.s("operation.Height.help"), options);
}
