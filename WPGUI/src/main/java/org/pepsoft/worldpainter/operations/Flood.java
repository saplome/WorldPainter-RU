...
public class Flood extends MouseOrTabletOperation {
    public Flood(WorldPainter view, boolean floodWithLava) {
        ...
        optionsPanel = floodWithLava
                ? new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.h2.32b9b4cf5b"), org.pepsoft.worldpainter.WPI18n.s("ui.h2.95f85068bf"))
                : new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.h2.ccd0f1cf0d"), org.pepsoft.worldpainter.WPI18n.s("ui.h2.e1eb50bf04"));
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(getView(), org.pepsoft.worldpainter.WPI18n.s("ui.h.c10eec7a9b"), org.pepsoft.worldpainter.WPI18n.s("ui.h.eb7ca5f641"), JOptionPane.ERROR_MESSAGE);
                }
            } finally {
                synchronized (dimension) {
