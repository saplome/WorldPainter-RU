...
public class Flood extends MouseOrTabletOperation {
    public Flood(WorldPainter view, boolean floodWithLava) {
        super(floodWithLava ? org.pepsoft.worldpainter.WPI18n.s("op.floodLava.name") : org.pepsoft.worldpainter.WPI18n.s("op.floodWater.name"), floodWithLava ? org.pepsoft.worldpainter.WPI18n.s("op.floodLava.desc") : org.pepsoft.worldpainter.WPI18n.s("op.floodWater.desc"),
                view,
        ...
        optionsPanel = floodWithLava
                ? new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.floodLava.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.floodLava.body"))
                : new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.floodWater.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.floodWater.body"));
    }
            ...
            try {
                ...
                try {
                    ...
                    if (flooder.isBoundsHit()) {
                        showWarning(getView(), org.pepsoft.worldpainter.WPI18n.s("operation.Flood.areaTooLarge.message"),
                    ...
                    JOptionPane.showMessageDialog(getView(), org.pepsoft.worldpainter.WPI18n.s("ui.message.floodAreaTooLarge"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.areaTooLarge.title"), JOptionPane.ERROR_MESSAGE);
                }
            } finally {
                synchronized (dimension) {
