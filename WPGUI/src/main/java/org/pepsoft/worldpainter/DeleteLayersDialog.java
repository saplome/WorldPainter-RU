...
public class DeleteLayersDialog extends WorldPainterDialog {
    ...
    private void deleteSelectedLayers() {
        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.68d049d3be") + jList1.getSelectedIndices().length + org.pepsoft.worldpainter.WPI18n.s("ui.h.3a1228301d"), org.pepsoft.worldpainter.WPI18n.s("ui.h.44928cfda5"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.delete_layers"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.the.following.layers.04b8216be4"));
        ...
        jButton2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.delete.selected.layers.80896816b9"));
