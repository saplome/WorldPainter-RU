...
public class ThreeDeeFrame extends JFrame implements WindowListener {
    public ThreeDeeFrame(Dimension dimension, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, Point initialCoords) throws HeadlessException {
        ...
        alwaysOnTopButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.set.the.d.view.b67e0c05da"));
        ...
        public void performAction(ActionEvent e) {
            ...
            if (selectedFile != null) {
                ...
                if (selectedFile.exists()) {
                    if (JOptionPane.showConfirmDialog(ThreeDeeFrame.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.b151fda588"), org.pepsoft.worldpainter.WPI18n.s("ui.h.e59b28f65a"), JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION) {
                        return;
                    }
                }
                ...
                if ((result != null) && result.equals(Boolean.FALSE)) {
                    JOptionPane.showMessageDialog(ThreeDeeFrame.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.b5d273411e") + type + org.pepsoft.worldpainter.WPI18n.s("ui.h.e69088726a"), org.pepsoft.worldpainter.WPI18n.s("information"), JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }
