...
public class ScriptRunner extends WorldPainterDialog {
    ...
    private void selectFile() {
        ...
        File script = FileUtils.selectFileForOpen(this, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.selectScript"), (File) comboBoxScript.getSelectedItem(), new FileFilter() {
            @Override
            ...
            public String getDescription() {
                return java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.script.filesFilter"),
    ...
    private void setupScript(File script) {
        ...
        if (scriptDescriptor != null) {
            ...
            if (scriptDescriptor.description != null) {
                addRegular(panelDescriptor, new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.d0042a700e")));
            ...
            if (! allFieldsOptional) {
                addlastOnLine(panelDescriptor, new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.d03bbd1a2a")));
            }
    ...
    private void run() {
        ...
        buttonCancel.setText(org.pepsoft.worldpainter.WPI18n.s("wp.abort.727b63583e"));
            ...
            public void run() {
                try {
                    ...
                    synchronized (SCRIPT_ENGINES) {
                        if (SCRIPT_ENGINES.containsKey(extension)) {
                            ...
                            if (scriptEngine == null) {
                                ...
                                doLaterOnEventThread(() -> beepAndShowError(ScriptRunner.this,
                                        java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.script.noEngine.message"), extension),
                                        org.pepsoft.worldpainter.WPI18n.s("ui.error.title")));
                                return;
                            }
                    ...
                    try {
                        ...
                        doLaterOnEventThread(() -> beepAndShowWarning(ScriptRunner.this, org.pepsoft.worldpainter.WPI18n.s("ui.script.aborted.message"), org.pepsoft.worldpainter.WPI18n.s("ui.script.aborted.title")));
                    } catch (RuntimeException e) {
                        logger.error(e.getClass().getSimpleName() + " occurred while executing " + scriptFileName, e);
                        doLaterOnEventThread(() -> beepAndShowError(ScriptRunner.this,
                                java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.script.runtimeError.message"), e.getClass().getSimpleName(), e.getMessage()),
                                org.pepsoft.worldpainter.WPI18n.s("ui.error.title")));
                        ...
                        doLaterOnEventThread(() -> beepAndShowError(ScriptRunner.this, sb.toString(), org.pepsoft.worldpainter.WPI18n.s("ui.error.title")));
                    } catch (IOException e) {
                        logger.error("I/O error occurred while executing " + scriptFileName, e);
                        doLaterOnEventThread(() -> beepAndShowError(ScriptRunner.this,
                                java.text.MessageFormat.format(org.pepsoft.worldpainter.WPI18n.s("ui.script.ioError.message"), scriptFileName),
                                org.pepsoft.worldpainter.WPI18n.s("ui.error.title")));
                    } finally {
                        if (dimension != null) {
    ...
    protected void cancel() {
        if (context != null) {
            ...
            nonResponsiveScriptWarningTimer = new Timer(10000,
                    evt -> showWarning(this, org.pepsoft.worldpainter.WPI18n.s("ui.script.unresponsive.message"), org.pepsoft.worldpainter.WPI18n.s("ui.script.unresponsive.title")));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.run_script"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.script.fd3879e779"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.parameters.d3d5b156c9"));

        textAreaParameters.setColumns(20);
        textAreaParameters.setRows(5);
        jScrollPane1.setViewportView(textAreaParameters);

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.one.per.line.8c8b6e3ca8"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.output.b1282d58a4"));

        buttonRun.setText(org.pepsoft.worldpainter.WPI18n.s("wp.run.c5301693c4"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.name.4e140ba723"));
