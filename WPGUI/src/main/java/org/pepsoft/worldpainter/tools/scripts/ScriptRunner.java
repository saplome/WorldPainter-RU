...
public class ScriptRunner extends WorldPainterDialog {
    ...
    private void setupScript(File script) {
        ...
        if (scriptDescriptor != null) {
            ...
            if (scriptDescriptor.description != null) {
                addRegular(panelDescriptor, new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.script.description")));
            ...
            if (! allFieldsOptional) {
                addlastOnLine(panelDescriptor, new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.script.mandatoryParameterNote")));
            }
    ...
    private void run() {
        ...
        buttonCancel.setText(org.pepsoft.worldpainter.WPI18n.s("ui.button.abort"));
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.runScript.title"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.script"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.parameters"));

        textAreaParameters.setColumns(20);
        textAreaParameters.setRows(5);
        jScrollPane1.setViewportView(textAreaParameters);

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.text.onePerLine"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.output"));

        buttonRun.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.run"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.name"));
