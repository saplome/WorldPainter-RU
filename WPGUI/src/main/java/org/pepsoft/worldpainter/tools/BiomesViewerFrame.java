...
public class BiomesViewerFrame extends JFrame {
    ...
    public BiomesViewerFrame(long seed, final Point marker, int preferredBiomeAlgorithm, ColourScheme colourScheme, SeedListener seedListener) throws HeadlessException {
                ...
                if (value instanceof Integer) {
                    switch ((Integer) value) {
                        ...
                        case BIOME_ALGORITHM_1_2_AND_1_3_DEFAULT:
                            setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.minecraft_1_2_1_6_default"));
                            break;
                        case BIOME_ALGORITHM_1_3_LARGE:
                            setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.minecraft_1_3_1_6_large"));
                            break;
                        case BIOME_ALGORITHM_1_7_DEFAULT:
                            setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.minecraft_1_7_1_12_default"));
                            break;
                        case BIOME_ALGORITHM_1_7_LARGE:
                            setText(org.pepsoft.worldpainter.WPI18n.s("ui.t.minecraft_1_7_1_12_large"));
                            break;
                    }
                }
                return this;
        ...
        if (! standAloneMode) {
            createWorldButton.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.create.a.new.worldpainter.36243bf4e0"));
        ...
        if (seedListener != null) {
            ...
            button.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.copy.the.current.seed.9b9f674402"));
        ...
        button.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.create.a.survival.in.465c051b9b"));
        button.addActionListener(event -> playHere(false));
        toolBar.add(button);

        toolBar.add(Box.createHorizontalStrut(5));
        button = new JButton(org.pepsoft.worldpainter.WPI18n.s("ui.3f1fdc4f20"));
        button.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.create.a.creative.in.a098d8c18c"));
    ...
    private void playHere(boolean creativeMode) {
        String name = JOptionPane.showInputDialog(BiomesViewerFrame.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.d7abc45a66"), org.pepsoft.worldpainter.WPI18n.s("ui.h.e893bded7c"), JOptionPane.QUESTION_MESSAGE);
        ...
        if (minecraftDirUsed) {
            JOptionPane.showMessageDialog(BiomesViewerFrame.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.2fa7c10c92"), org.pepsoft.worldpainter.WPI18n.s("information"), JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(BiomesViewerFrame.this, org.pepsoft.worldpainter.WPI18n.s("ui.h.9a49d03d08") + worldDir + org.pepsoft.worldpainter.WPI18n.s("ui.h.eafa902459"), org.pepsoft.worldpainter.WPI18n.s("information"), JOptionPane.INFORMATION_MESSAGE);
        }
    }
