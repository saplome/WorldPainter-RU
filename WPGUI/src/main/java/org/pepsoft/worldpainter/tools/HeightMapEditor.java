...
public class HeightMapEditor extends javax.swing.JFrame implements HeightMapPropertiesPanel.HeightMapListener {
    ...
    private void createHeightMap() {
        ...
        jTree1.addMouseListener(new MouseAdapter() {
            ...
            private void showPopupMenu(MouseEvent event) {
                ...
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.heightMapEditor.ninePatch"));
                menuItem.addActionListener(actionEvent -> {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.heightMapEditor.title"));

        jToolBar1.setRollover(true);

        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.newSeed"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.viewAs"));
        jToolBar1.add(jLabel1);

        buttonGroup1.add(radioButtonViewAsHeightMap);
        radioButtonViewAsHeightMap.setSelected(true);
        radioButtonViewAsHeightMap.setText(org.pepsoft.worldpainter.WPI18n.s("ui.height.heightMap"));
        ...
        radioButtonViewAsTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("ui.terrain.terrain"));
        ...
        checkBoxShowGrid.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.showGrid"));
...
//        rootHeightMap = new DisplacementHeightMap(scaledHeightMap, angleMap, distanceMap);
    ...
    private static void configError(Throwable e) {
        ...
        JOptionPane.showMessageDialog(null, org.pepsoft.worldpainter.WPI18n.s("ui.message.configReadErrorPrefix") + e.getClass().getSimpleName() + org.pepsoft.worldpainter.WPI18n.s("ui.frag.exceptionMessageLabel") + e.getMessage(), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.configurationError.title"), JOptionPane.ERROR_MESSAGE);
    }
