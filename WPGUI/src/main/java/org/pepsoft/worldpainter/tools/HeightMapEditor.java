...
public class HeightMapEditor extends javax.swing.JFrame implements HeightMapPropertiesPanel.HeightMapListener {
    ...
    private void createHeightMap() {
        ...
        jTree1.addMouseListener(new MouseAdapter() {
            ...
            private void showPopupMenu(MouseEvent event) {
                ...
                JMenuItem menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.777755ffc3"));
                ...
                JMenu insertMenu = new JMenu(org.pepsoft.worldpainter.WPI18n.s("ui.a458be0f08"));
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.deb1051765"));
                menuItem.addActionListener(actionEvent -> {
                ...
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.a0ec87054b"));
                menuItem.addActionListener(actionEvent -> {
                    SumHeightMap sumHeightMap = new SumHeightMap(heightMap, new ConstantHeightMap(0.0f));
                    replace(parent, heightMap, sumHeightMap);
                });
                insertMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.8321e79c27"));
                menuItem.addActionListener(actionEvent -> {
                ...
                insertMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.fe1675056f"));
                menuItem.addActionListener(actionEvent -> {
                    SlopeHeightMap slopeHeightMap = new SlopeHeightMap(heightMap);
                    replace(parent, heightMap, slopeHeightMap);
                });
                insertMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.7ed77d076d"));
                menuItem.addActionListener(actionEvent -> {
                ...
                insertMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.7793401b28"));
                menuItem.addActionListener(actionEvent -> {
                ...
                insertMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.bb53c62475"));
                menuItem.addActionListener(actionEvent -> {
                ...
                insertMenu.add(menuItem);
                menu.add(insertMenu);
                JMenu replaceMenu = new JMenu(org.pepsoft.worldpainter.WPI18n.s("ui.0ebe6df8a3"));
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.2283f852a3"));
                menuItem.addActionListener(actionEvent -> {
                ...
                replaceMenu.add(menuItem);
                menuItem = new JMenuItem(org.pepsoft.worldpainter.WPI18n.s("ui.0a976d6874"));
                menuItem.addActionListener(actionEvent -> {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.height_map_editor"));

        jToolBar1.setRollover(true);

        jButton1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.new.seed.246c88e498"));
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.view.as.aca1ce8d0a"));
        jToolBar1.add(jLabel1);

        buttonGroup1.add(radioButtonViewAsHeightMap);
        radioButtonViewAsHeightMap.setSelected(true);
        radioButtonViewAsHeightMap.setText(org.pepsoft.worldpainter.WPI18n.s("wp.height.map.bc0ce1ed0b"));
        ...
        radioButtonViewAsTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.terrain.47afa88cfb"));
        ...
        checkBoxShowGrid.setText(org.pepsoft.worldpainter.WPI18n.s("wp.show.grid.6e729a74b8"));
...
//        rootHeightMap = new DisplacementHeightMap(scaledHeightMap, angleMap, distanceMap);
    ...
    private static void configError(Throwable e) {
        ...
        JOptionPane.showMessageDialog(null, org.pepsoft.worldpainter.WPI18n.s("ui.h.dbe4094965") + e.getClass().getSimpleName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.9592694e0b") + e.getMessage(), org.pepsoft.worldpainter.WPI18n.s("ui.h.cb1d610e8b"), JOptionPane.ERROR_MESSAGE);
    }
