...
public class ImportHeightMapDialog extends WorldPainterDialog implements DocumentListener, SimpleThemeEditor.ChangeListener {
    ...
    public World2 getImportedWorld() {
        ...
        World2 world = ProgressDialog.executeTask(this, new ProgressTask<World2>() {
            ...
            public String getName() {
                return org.pepsoft.worldpainter.WPI18n.s("importing.height.map");
            }
    ...
    private HeightMapImporter createImporter(boolean interactive) {
        ...
        if ((selectedFile == null) || (! selectedFile.exists())) {
            if (interactive) {
                beepAndShowError(this, org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.noFile.message"), org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.noFile.title"));
            }
            return null;
        } else if (image == null) {
            if (interactive) {
                beepAndShowError(this, org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.noValidImage.message"), org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.noValidImage.title"));
            }
            return null;
        }
    ...
    private void loadImage() {
        try {
            ...
            if (image == null) {
                ...
                labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.not.an.image.file.8d5b815a17"));
                selectedFile = null;
            } else if ((image.getType() == BufferedImage.TYPE_BYTE_BINARY) || (image.getType() == BufferedImage.TYPE_BYTE_INDEXED)) {
                labelImageDimensions.setForeground(Color.RED);
                labelImageDimensions.setIcon(ICON_WARNING);
                labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.indexed.image.not.supported.0d1e3c636e"));
                selectedFile = null;
            } else if (image.isAlphaPremultiplied()) {
                labelImageDimensions.setForeground(Color.RED);
                labelImageDimensions.setIcon(ICON_WARNING);
                labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.premultiplied.alpha.not.supported.533928bf73"));
                selectedFile = null;
            } else {
            ...
            if (e.getMessage().equals("Invalid scanline stride")) {
                labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.image.data.too.large.9ca6cc48c0"));
            } else {
    ...
    private void updateWorldDimensions() {
        ...
        if (westEastTime.equals(northSouthTime)) {
            ...
            labelWalkingTime.setText(org.pepsoft.worldpainter.WPI18n.s("ui.71310fb090") + westEastTime + org.pepsoft.worldpainter.WPI18n.s("ui.h.297d9b178e") + northSouthTime);
        }
    }
    ...
    private void resetDefaults() {
        if (currentDimension != null) {
            ...
            loadDefaults();
            buttonSaveAsDefaults.setEnabled(false);
            showInfo(this, org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.defaultThemeReset.message"), org.pepsoft.worldpainter.WPI18n.s("ui.importHeightMap.defaultThemeReset.title"));
        }
    }
        ...
        if (currentDimension != null) {
            ...
            if (! config.isMessageDisplayedCountAtLeast(MESSAGE_KEY_MASTER_WARNING, 3)) {
                ...
                if (JOptionPane.showConfirmDialog(this, /* language=HTML */ "<html>" +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.aed53983cd") +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.280671966c") +
                        "<ul>" +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.7f95de1f26") +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.9b3d55caf2") +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.9505ae16d5") + COMMAND_KEY_NAME + org.pepsoft.worldpainter.WPI18n.s("ui.h.9b9adb4213") + COMMAND_KEY_NAME + org.pepsoft.worldpainter.WPI18n.s("ui.h.58df0264b7") +
                        "</ul>" +
                        org.pepsoft.worldpainter.WPI18n.s("ui.h.a7366331f0") +
                        "</html>", org.pepsoft.worldpainter.WPI18n.s("ui.h.b6e70d44af"), YES_NO_OPTION, WARNING_MESSAGE) != YES_OPTION) {
                    return;
                }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.import_height_map"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.image.to.ab76ee3030"));
        ...
        labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.image.size.x.bit.27d0860130"));
        ...
        checkBoxInvert.setText(org.pepsoft.worldpainter.WPI18n.s("wp.invert.white.is.low.d64477884e"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.fe141d7089"));
        ...
        labelWorldDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scaled.size.x.blocks.9736758c70"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("wp.from.image.05015ebae3"));
        ...
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.to.minecraft.dedf162e37"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("wp.low.mapping.90d7f8d645"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel8.setText(org.pepsoft.worldpainter.WPI18n.s("wp.water.level.3cd4b936aa"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel9.setText(org.pepsoft.worldpainter.WPI18n.s("wp.high.mapping.618c9631a1"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel15.setText(org.pepsoft.worldpainter.WPI18n.s("wp.lowest.value.1e81e7c538"));
        jLabel15.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.lowest.value.that.6d0dfc5d57"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel18.setText(org.pepsoft.worldpainter.WPI18n.s("wp.highest.value.2f30ee1706"));
        jLabel18.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.highest.value.that.2f7af31a1d"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        labelWarningCutOffAbove.setText(org.pepsoft.worldpainter.WPI18n.s("wp.cut.off.above.0dd0705bf4"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        labelWarningCutOffBelow.setText(org.pepsoft.worldpainter.WPI18n.s("wp.cut.off.below.724bd02e98"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        ...
        jLabel16.setText(org.pepsoft.worldpainter.WPI18n.s("wp.build.limit.d83f9f4420"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel17.setText(org.pepsoft.worldpainter.WPI18n.s("wp.build.limit.d83f9f4420"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.build.limits.lower.5613dfcc61"));

        jLabel10.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.e734964953"));

        checkBoxVoid.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.void.below.image.1be32c9798"));
        ...
        jLabel11.setText(org.pepsoft.worldpainter.WPI18n.s("wp.offset.f2437d6ccf"));
        jLabel11.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.origin.of.the.34a9ea49a9"));

        spinnerOffsetX.setModel(new javax.swing.SpinnerNumberModel(0, -999999, 999999, 1));
        spinnerOffsetX.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.origin.of.the.34a9ea49a9"));
        ...
        jLabel12.setText(",");
        jLabel12.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.origin.of.the.34a9ea49a9"));

        spinnerOffsetY.setModel(new javax.swing.SpinnerNumberModel(0, -999999, 999999, 1));
        spinnerOffsetY.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.the.origin.of.the.34a9ea49a9"));
        ...
        jLabel14.setText(org.pepsoft.worldpainter.WPI18n.s("wp.edge.to.edge.walking.b00096991c"));

        labelWalkingTime.setText("...");

        themeButtonGroup.add(radioButtonApplyTheme);
        radioButtonApplyTheme.setSelected(true);
        radioButtonApplyTheme.setText(org.pepsoft.worldpainter.WPI18n.s("wp.apply.theme.73ac96c706"));
        ...
        radioButtonSingleTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.single.8826c9ff71"));
        ...
        jLabel19.setText(org.pepsoft.worldpainter.WPI18n.s("wp.preset.d0a22fb077"));
        ...
        jLabel20.setText(org.pepsoft.worldpainter.WPI18n.s("wp.exported.size.be8c600cea"));

        labelExportedSize.setText(org.pepsoft.worldpainter.WPI18n.s("wp.x.blocks.0e94fdccad"));

        jLabel22.setText(org.pepsoft.worldpainter.WPI18n.s("wp.exported.offset.eec706e50d"));
        ...
        jLabel21.setText(org.pepsoft.worldpainter.WPI18n.s("wp.upper.c9aee88397"));

        jLabel23.setText(org.pepsoft.worldpainter.WPI18n.s("wp.terrain.7c0f7d712b"));

        themeButtonGroup.add(radioButtonLeaveTerrain);
        radioButtonLeaveTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.leave.6c374e7033"));
        ...
        buttonLoadDefaults.setText(org.pepsoft.worldpainter.WPI18n.s("wp.load.defaults.8d3e881ecb"));
        ...
        buttonSaveAsDefaults.setText(org.pepsoft.worldpainter.WPI18n.s("wp.save.as.defaults.f9a1126db5"));
        ...
        buttonResetDefaults.setText(org.pepsoft.worldpainter.WPI18n.s("wp.reset.526d688f37"));
        ...
        checkBoxCreateTiles.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.new.tiles.96d38a4375"));

        labelNoUndo.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.b.note.b.d06bc13176"));

        checkBoxOnlyRaise.setText(org.pepsoft.worldpainter.WPI18n.s("wp.only.where.higher.5fe114ac27"));
        checkBoxOnlyRaise.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.when.selected.the.height.74404e4937"));
        ...
        jLabel13.setText(org.pepsoft.worldpainter.WPI18n.s("wp.map.format.980a0dbfbe"));
        ...
        checkBoxMasterDimension.setText(org.pepsoft.worldpainter.WPI18n.s("wp.create.as.master.dimension.c83954b3e8"));
