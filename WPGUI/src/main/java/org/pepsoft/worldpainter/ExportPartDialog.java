...
public class ExportPartDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.export.exportPartOfThe"));

        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.onAndLaterImport"));

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.selectTilesToExport"));

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.nameOfTheNew"));

        fieldName.setColumns(20);
        fieldName.setText("jTextField1");

        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.directoryToExportThe"));
