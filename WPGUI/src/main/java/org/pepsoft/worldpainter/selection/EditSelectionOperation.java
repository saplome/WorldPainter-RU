...
//                selectionState.setValue(true);
    ...
    private static final JPanel OPTIONS_PANEL = new StandardOptionsPanel(org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.editSelection.title"), org.pepsoft.worldpainter.WPI18n.s("ui.help.tool.editSelection.body"));
