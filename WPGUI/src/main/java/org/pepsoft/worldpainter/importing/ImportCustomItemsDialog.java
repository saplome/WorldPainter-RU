...
public class ImportCustomItemsDialog extends WorldPainterDialog implements TreeSelectionListener {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.import_custom_items"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.selected.world.fed8a5ff27"));

        labelWorld.setText("jLabel2");

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.which.custom.item.f049efe425"));
