...
public class MapImportDialog extends WorldPainterDialog {
    ...
    private void analyseMap() {
        ...
        if (mapInfo == null) {
            ...
            JOptionPane.showMessageDialog(MapImportDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.couldNotDetermineMapFormatPrefix") + worldDir.getName(), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.unidentifiedMapFormat.title"), ERROR_MESSAGE);
            // TODO
            return;
        }
        ...
        if (! mapInfo.platform.capabilities.contains(BLOCK_BASED)) {
            ...
            JOptionPane.showMessageDialog(MapImportDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.nonBlockBasedFormatPrefix") + platform + org.pepsoft.worldpainter.WPI18n.s("ui.frag.notYetSupportedSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.unsupportedMapFormat.title"), ERROR_MESSAGE);
            return;
            ...
            JOptionPane.showMessageDialog(MapImportDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.mapFormatPluginPrefix") + platform + org.pepsoft.worldpainter.WPI18n.s("ui.frag.noImportSupportSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.importingNotSupported.title"), ERROR_MESSAGE);
            return;
        }
        ...
        if (DEFAULT_JAVA_PLATFORMS.contains(platform)) {
            ...
            if (version == VERSION_UNKNOWN) {
                ...
                JOptionPane.showMessageDialog(MapImportDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.message.moddedMapsNotSupported"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.moddedMap.title"), ERROR_MESSAGE);
                return;
        ...
        if (! dimensions.contains(DIM_NORMAL)) {
            ...
            JOptionPane.showMessageDialog(MapImportDialog.this, org.pepsoft.worldpainter.WPI18n.s("ui.dialog.missingSurfaceDimension.message"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.missingSurfaceDimension.title"), ERROR_MESSAGE);
            return;
        }
        ...
        if ((mapStatistics != null) && (mapStatistics.chunkCount > 0)) {
            ...
            labelWidth.setText(FORMATTER.format(width * 16L) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.blocksFrom") + FORMATTER.format((long) mapStatistics.lowestChunkX << 4) + " to " + FORMATTER.format(((long) mapStatistics.highestChunkX << 4) + 15) + "; " + FORMATTER.format(width) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.chunksSuffix"));
            labelLength.setText(FORMATTER.format(length * 16L) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.blocksFrom") + FORMATTER.format((long) mapStatistics.lowestChunkZ << 4) + " to " + FORMATTER.format(((long) mapStatistics.highestChunkZ << 4) + 15) + "; " + FORMATTER.format(length) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.chunksSuffix"));
            labelArea.setText(FORMATTER.format(area * 256L) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.blocksOpenParen") + FORMATTER.format(area) + org.pepsoft.worldpainter.WPI18n.s("ui.frag.chunksSuffix"));
        }
    }
    ...
    private void resetStats() {
        labelWidth.setText(org.pepsoft.worldpainter.WPI18n.s("ui.unit.blocksFromToChunks"));
        labelLength.setText(org.pepsoft.worldpainter.WPI18n.s("ui.unit.blocksFromToChunks"));
        labelArea.setText(org.pepsoft.worldpainter.WPI18n.s("ui.unit.blocksChunks"));
    }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.importExistingMap.title"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.selectAnExistingMap"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.statisticsForSurface"));

        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.width"));

        labelWidth.setText("0");

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.length"));

        labelLength.setText("0");

        jLabel7.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.area"));
        ...
        jLabel5.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.options"));

        buttonGroup1.add(radioButtonReadOnlyNone);
        radioButtonReadOnlyNone.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.doNotMarkAny"));

        buttonGroup1.add(radioButtonReadOnlyManMade);
        radioButtonReadOnlyManMade.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.markChunksContainingMan"));

        buttonGroup1.add(radioButtonReadOnlyAll);
        radioButtonReadOnlyAll.setText(org.pepsoft.worldpainter.WPI18n.s("ui.field.markAllChunksRead"));

        buttonGroup1.add(radioButtonReadOnlyManMadeAboveGround);
        radioButtonReadOnlyManMadeAboveGround.setSelected(true);
        radioButtonReadOnlyManMadeAboveGround.setText(org.pepsoft.worldpainter.WPI18n.s("ui.html.htmlMarkChunksContaining"));

        checkBoxImportSurface.setSelected(true);
        checkBoxImportSurface.setText(org.pepsoft.worldpainter.WPI18n.s("ui.import.importSurface"));
        checkBoxImportSurface.setEnabled(false);

        checkBoxImportNether.setText(org.pepsoft.worldpainter.WPI18n.s("ui.import.importNether"));
        checkBoxImportNether.setEnabled(false);

        checkBoxImportEnd.setText(org.pepsoft.worldpainter.WPI18n.s("ui.import.importEnd"));
        checkBoxImportEnd.setEnabled(false);

        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("ui.label.mapFormat"));
