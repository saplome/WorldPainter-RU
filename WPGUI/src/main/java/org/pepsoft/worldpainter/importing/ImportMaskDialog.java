...
public class ImportMaskDialog extends WorldPainterDialog implements DocumentListener {
    ...
    private void loadImage() {
        try {
            ...
            if (image == null) {
                ...
                labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.not.an.image.file.633229b072"));
                selectedFile = null;
        ...
        try {
            ProgressDialog.executeTask(this, new ProgressTask<Void>() {
                ...
                public String getName() {
                    return org.pepsoft.worldpainter.WPI18n.s("importing.mask");
                }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.import_mask"));

        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.image.to.5cf520eca1"));
        ...
        labelImageDimensions.setText(org.pepsoft.worldpainter.WPI18n.s("wp.html.image.size.x.28d9318d66"));
        ...
        jLabel2.setText(org.pepsoft.worldpainter.WPI18n.s("wp.apply.to.dd576e6886"));

        buttonGroup1.add(radioButtonTerrain);
        radioButtonTerrain.setText(org.pepsoft.worldpainter.WPI18n.s("wp.terrain.4eda8e627d"));
        ...
        radioButtonLayer.setText(org.pepsoft.worldpainter.WPI18n.s("wp.layer.f56b53e412"));
        ...
        jLabel3.setText(org.pepsoft.worldpainter.WPI18n.s("wp.select.the.mapping.759352f35c"));

        spinnerThreshold.setModel(new javax.swing.SpinnerNumberModel(0.0d, 0.0d, 255.0d, 1.0d));
        spinnerThreshold.setEnabled(false);

        jLabel4.setText(org.pepsoft.worldpainter.WPI18n.s("wp.scale.fe141d7089"));
        ...
        checkBoxRemoveExisting.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.existing.layer.659d60922f"));
        ...
        jLabel6.setText(org.pepsoft.worldpainter.WPI18n.s("wp.threshold.02505a7781"));

        labelMaskRange.setText(org.pepsoft.worldpainter.WPI18n.s("wp.actual.mask.range.63e41c3506"));
