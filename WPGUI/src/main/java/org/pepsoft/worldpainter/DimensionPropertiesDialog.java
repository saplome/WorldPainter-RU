...
public class DimensionPropertiesDialog extends WorldPainterDialog {
    ...
    public DimensionPropertiesDialog(Window parent, Dimension dimension, ColourScheme colourScheme, CustomBiomeManager customBiomeManager, boolean defaultSettingsMode) {
        ...
        if (defaultSettingsMode) {
            ...
            setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.editDefaultDimensionProperties.title"));
        } else {
            worldPropertiesEditor1.init(colourScheme, customBiomeManager, dimension, DimensionPropertiesEditor.Mode.EDITOR);
            setTitle(org.pepsoft.worldpainter.WPI18n.format("ui.dialog.editDimensionProperties.title",
                    org.pepsoft.worldpainter.WPI18n.dimensionName(dimension)));
        }
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.editDimensionProperties.title"));
        ...
        jButton2.setText(org.pepsoft.worldpainter.WPI18n.s("ui.button.ok"));
