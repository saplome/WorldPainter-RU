...
//            riverGenerator.generateRivers();
    ...
    public static World2 createDefaultWorldWithoutTiles(final Configuration config, final long seed) {
        ...
        final ResourceBundle strings = ResourceBundle.getBundle("org.pepsoft.worldpainter.resources.strings", java.util.Locale.getDefault(), org.pepsoft.worldpainter.Utf8Control.INSTANCE);
