...
//        jPanel2.add(miniMap, BorderLayout.CENTER);
    ...
    public void setScale(float scale) {
        ...
        jLabel1.setText(WPI18n.format("ui.scale.blocks", SCALE_NUMBER_FORMAT.format(scaleBarSize)));
        repaint();
    }
    ...
    private JLabel createLabel(Layer layer) {
        ...
        label.setToolTipText(layer.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.frag.layerHidden"));
        return label;
    }
    ...
    private JLabel createSoloLabel(Layer layer) {
        ...
        JLabel label = new JLabel(new ImageIcon(image));
        label.setBorder(new EmptyBorder(1, 1, 1, 1));
        label.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.glassPane.showingOnlyPrefix") + layer.getName() + " layer");
        return label;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.unit.blocks"));
...
//    private final MiniMap miniMap = new MiniMap();
    ...
    private static final NumberFormat SCALE_NUMBER_FORMAT = new DecimalFormat("#,##0.#");
