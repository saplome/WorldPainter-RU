...
//        jPanel2.add(miniMap, BorderLayout.CENTER);
    ...
    private JLabel createLabel(Layer layer) {
        ...
        label.setToolTipText(layer.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.05a1ead3b4"));
        return label;
    }
    ...
    private JLabel createSoloLabel(Layer layer) {
        ...
        JLabel label = new JLabel(new ImageIcon(image));
        label.setBorder(new EmptyBorder(1, 1, 1, 1));
        label.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.4f01a733cc") + layer.getName() + " layer");
        return label;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.blocks.808f424b7f"));
