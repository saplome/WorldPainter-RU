...
public class CustomLayerController implements PropertyChangeListener {
    ...
    public List<Component> createCustomLayerButton(final CustomLayer layer) {
        ...
        button.setToolTipText(button.getToolTipText() + org.pepsoft.worldpainter.WPI18n.s("ui.tooltip.rightClickForOptions"));
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            private void showPopup(MouseEvent e) {
                ...
                JMenuItem menuItem = new JMenuItem(strings.getString("ui.menu.edit") + "...");
                ...
                if (layer.isExportableToFile()) {
                    ...
                    menuItem.setEnabled(false);
                    menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.thisLayerCannotBeCannotBe"));
                }
                popup.add(menuItem);
                ...
                if (layer.isExportableToFile()) {
                    ...
                    menuItem.setEnabled(false);
                    menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("ui.text.thisLayerCannotBe"));
                }
                popup.add(menuItem);
    ...
    void editCustomLayer(CustomLayer layer, Runnable callback) {
        ...
        dialog.setVisible(() -> {
            ...
            if (control != null) {
                ...
                control.setToolTipText(layer.getName() + ": " + layer.getDescription() + org.pepsoft.worldpainter.WPI18n.s("ui.tooltip.rightClickForOptions"));
            }
    ...
    private void exportLayer(CustomLayer layer) {
        ...
        if (selectedFile != null) {
            ...
            if (selectedFile.isFile() && (showConfirmDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.message.filePrefix") + selectedFile.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.fileAlreadyExistsSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.overwriteFile.title"), YES_NO_OPTION) == NO_OPTION)) {
                return;
            }
            try {
    ...
    private void createNewLayerPalette(CustomLayer layer) {
        String name;
        if ((name = showInputDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.prompt.enterNewPaletteName"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.newPalette.title"), QUESTION_MESSAGE)) != null) {
            name = name.trim();
            if (name.isEmpty()) {
            ...
            if (paletteManager.getPalette(name) != null) {
                showMessageDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.message.paletteNameDuplicate"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.duplicateName.title"), ERROR_MESSAGE);
                return;
            }
