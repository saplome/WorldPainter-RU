...
public class CustomLayerController implements PropertyChangeListener {
    ...
    public List<Component> createCustomLayerButton(final CustomLayer layer) {
        ...
        button.setToolTipText(button.getToolTipText() + org.pepsoft.worldpainter.WPI18n.s("ui.h.b142f7d0b1"));
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            private void showPopup(MouseEvent e) {
                            ...
                            menuItem.addActionListener(e1 -> {
                                ...
                                if (! config.isMessageDisplayedCountAtLeast(EDITING_FLOOR_DIMENSION_KEY_2, 3)) {
                                    doLaterOnEventThread(() -> JOptionPane.showMessageDialog(app,
                                            org.pepsoft.worldpainter.WPI18n.s("ui.h.18aaf60865") + longName + ",\n" +
                                                    org.pepsoft.worldpainter.WPI18n.s("ui.h.270c92c7ef") + COMMAND_KEY_NAME + "+U.\n\n" +
                                                    org.pepsoft.worldpainter.WPI18n.s("ui.h.e2b1dfa70d") +
                                                    org.pepsoft.worldpainter.WPI18n.s("ui.h.0dbc2bbd33") + longName + ".", org.pepsoft.worldpainter.WPI18n.s("ui.h.3de82a8325") + longName, JOptionPane.INFORMATION_MESSAGE));
                                    config.setMessageDisplayed(EDITING_FLOOR_DIMENSION_KEY_2);
                                }

                                final JLabel label = new JLabel(org.pepsoft.worldpainter.WPI18n.s("ui.h.ab47702a95") + longName + ".</font></html>");
                ...
                if (layer.isExportableToFile()) {
                    ...
                    menuItem.setEnabled(false);
                    menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.this.layer.cannot.be.bb67256016"));
                }
                popup.add(menuItem);
                ...
                if (layer.isExportableToFile()) {
                    ...
                    menuItem.setEnabled(false);
                    menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.this.layer.cannot.be.88ca03b851"));
                }
                popup.add(menuItem);
    ...
    JPopupMenu createCustomLayerMenu(final String paletteName) {
        ...
        menuItem.setToolTipText(org.pepsoft.worldpainter.WPI18n.s("wp.this.will.make.a.1c657f0ace"));
    ...
    void editCustomLayer(CustomLayer layer, Runnable callback) {
        ...
        dialog.setVisible(() -> {
            ...
            if (control != null) {
                ...
                control.setToolTipText(layer.getName() + ": " + layer.getDescription() + org.pepsoft.worldpainter.WPI18n.s("ui.h.b142f7d0b1"));
            }
    ...
    void deleteUnusedLayers() {
        ...
        if (unusedLayers.isEmpty()) {
            showInfo(app, WPI18n.s("ui.customLayers.noUnused.message"), WPI18n.s("ui.customLayers.noUnused.title"));
        } else {
            final DeleteLayersDialog dialog = new DeleteLayersDialog(app, unusedLayers);
            dialog.setVisible(true);
            if (! dialog.isCancelled()) {
                showInfo(app, WPI18n.s("ui.customLayers.layersDeleted.message"), WPI18n.s("ui.customLayers.layersDeleted.title"));
            }
        }
    }
    ...
    boolean importCustomLayer(CustomLayer layer) {
        ...
        if (layer instanceof CombinedLayer combinedLayer) {
            ...
            if (! combinedLayer.restoreCustomTerrain()) {
                showWarning(app, WPI18n.s("ui.customLayers.customTerrainNotRestored.message"), WPI18n.s("ui.customLayers.customTerrainNotRestored.title"));
            } else {
    ...
    private void findLayer(Layer layer) {
        ...
        if (closestDistance.get() == Double.MAX_VALUE) {
            beep();
            showInfo(view,
                    java.text.MessageFormat.format(WPI18n.s("ui.customLayers.layerNotPresent.message"), layer),
                    WPI18n.s("ui.customLayers.layerNotPresent.title"));
        } else {
    ...
    private void exportLayer(CustomLayer layer) {
        ...
        File selectedFile = FileUtils.selectFileForSave(app, org.pepsoft.worldpainter.WPI18n.s("ui.dlg.exportLayerFile"), new File(layerDirectory, org.pepsoft.util.FileUtils.sanitiseName(layer.getName()) + ".layer"), new FileFilter() {
            @Override
        ...
        if (selectedFile != null) {
            ...
            if (selectedFile.isFile() && (showConfirmDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.h.0b8c2d31e3") + selectedFile.getName() + org.pepsoft.worldpainter.WPI18n.s("ui.h.859e1b0d68"), org.pepsoft.worldpainter.WPI18n.s("ui.h.b06d9a520d"), YES_NO_OPTION) == NO_OPTION)) {
                return;
            }
            try {
            ...
            showInfo(app,
                    java.text.MessageFormat.format(WPI18n.s("ui.customLayers.layerExported.message"), layer.getName()),
    ...
    private void createNewLayerPalette(CustomLayer layer) {
        String name;
        if ((name = showInputDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.h.78cf2b71ec"), org.pepsoft.worldpainter.WPI18n.s("ui.h.54527ab69e"), QUESTION_MESSAGE)) != null) {
            name = name.trim();
            if (name.isEmpty()) {
                beepAndShowError(app, WPI18n.s("ui.palette.emptyName.message"), WPI18n.s("ui.invalidName.title"));
                return;
            }
            if (paletteManager.getPalette(name) != null) {
                showMessageDialog(app, org.pepsoft.worldpainter.WPI18n.s("ui.h.64a17e86f4"), org.pepsoft.worldpainter.WPI18n.s("ui.h.f28d56eba0"), ERROR_MESSAGE);
                return;
            }
