...
public class TileEditor extends WorldPainterModalFrame implements TileSelector.Listener {
    ...
    private void addTiles() {
        ...
        if (totalEstimatedSize > availableMemory) {
            if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.addTilesMemoryWarningPrefix") + tilesToAdd.size() + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.addManyTilesMemoryWarningSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.tooManyTiles.title"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) != JOptionPane.YES_OPTION) {
                return;
            }
        } else {
            ...
            if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.doYouWantTo") + action + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.cannotUndoNoteSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmAddTiles.title"), JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION) {
                return;
            }            
        }
    ...
    private void removeTiles() {
        ...
        if (tilesToRemove.size() == dimension.getTileCount()) {
            JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.message.cannotRemoveAllTiles"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.allTilesSelected.title"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeTilesCountPrefix") + tilesToRemove.size() + org.pepsoft.worldpainter.WPI18n.s("ui.confirm.removeTilesCountSuffix"), org.pepsoft.worldpainter.WPI18n.s("ui.dialog.confirmRemoveTiles.title"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            dimension.setEventsInhibited(true);
            dimension.clearUndo();
            try {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.dialog.tileEditor.title"));
        ...
        buttonAddTiles.setText(org.pepsoft.worldpainter.WPI18n.s("ui.action.addOrExpandTiles"));
        ...
        buttonRemoveTiles.setText(org.pepsoft.worldpainter.WPI18n.s("ui.action.removeTiles"));
        ...
        jTextPane1.setText(org.pepsoft.worldpainter.WPI18n.s("ui.help.tileEditor"));
