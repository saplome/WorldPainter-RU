...
public class TileEditor extends WorldPainterModalFrame implements TileSelector.Listener {
    ...
    private void addTiles() {
        ...
        if (totalEstimatedSize > availableMemory) {
            if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.70a9d67d8e") + tilesToAdd.size() + org.pepsoft.worldpainter.WPI18n.s("ui.h.dbc6b7d3f5"), org.pepsoft.worldpainter.WPI18n.s("ui.h.9783f32dec"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) != JOptionPane.YES_OPTION) {
                return;
            }
        } else {
            ...
            if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.160840adcd") + action + org.pepsoft.worldpainter.WPI18n.s("ui.h.e8adc78f3f"), org.pepsoft.worldpainter.WPI18n.s("ui.h.592fb397ce"), JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION) {
                return;
            }            
        }
    ...
    private void removeTiles() {
        ...
        if (tilesToRemove.size() == dimension.getTileCount()) {
            JOptionPane.showMessageDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.08d355bd0e"), org.pepsoft.worldpainter.WPI18n.s("ui.h.46a6034b0b"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (JOptionPane.showConfirmDialog(this, org.pepsoft.worldpainter.WPI18n.s("ui.h.575584d8aa") + tilesToRemove.size() + org.pepsoft.worldpainter.WPI18n.s("ui.h.018f0d7527"), org.pepsoft.worldpainter.WPI18n.s("ui.h.bdb2ef9977"), JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            dimension.setEventsInhibited(true);
            dimension.clearUndo();
            try {
    ...
    private void initComponents() {
        ...
        setTitle(org.pepsoft.worldpainter.WPI18n.s("ui.t.worldpainter_add_expand_or_remove_tiles"));
        ...
        buttonAddTiles.setText(org.pepsoft.worldpainter.WPI18n.s("wp.add.or.expand.tiles.e9d96fd046"));
        ...
        buttonRemoveTiles.setText(org.pepsoft.worldpainter.WPI18n.s("wp.remove.tiles.2fc5143860"));
        ...
        jTextPane1.setText(org.pepsoft.worldpainter.WPI18n.s("wp.worldpainter.works.in.tiles.b4b3efbc07"));
