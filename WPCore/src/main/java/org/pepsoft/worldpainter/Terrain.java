...
//        private int highestLava = 0;
    ...
    public String getName() {
        final String key = "terrain." + name();
        final String localized = WPI18n.s(key);
        return localized.equals(key) ? name : localized;
    }
    ...
    public String getDescription() {
        final String dkey = "terrain." + name() + ".desc";
        final String dloc = org.pepsoft.worldpainter.WPI18n.s(dkey);
        return dloc.equals(dkey) ? description : dloc;
    }
